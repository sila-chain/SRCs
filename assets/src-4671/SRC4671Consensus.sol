...
import "./SRC4671.sol";
import "./ISRC4671Consensus.sol";

contract SRC4671Consensus is SRC4671, ISRC4671Consensus {
    ...
    constructor (string memory name_, string memory symbol_, address[] memory voters_) SRC4671(name_, symbol_) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ISRC165, SRC4671) returns (bool) {
        return 
            interfaceId == type(ISRC4671Consensus).interfaceId ||
