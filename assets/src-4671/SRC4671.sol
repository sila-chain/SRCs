...
import "./ISRC4671.sol";
import "./ISRC4671Metadata.sol";
import "./ISRC4671Enumerable.sol";

abstract contract SRC4671 is ISRC4671, ISRC4671Metadata, ISRC4671Enumerable, SRC165 {
    // Token data
    struct Token {
        address issuer;
        address owner;
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(SRC165, ISRC165) returns (bool) {
        return 
            interfaceId == type(ISRC4671).interfaceId ||
            interfaceId == type(ISRC4671Metadata).interfaceId ||
            interfaceId == type(ISRC4671Enumerable).interfaceId ||
