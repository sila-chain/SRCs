...
import "./ISRC4671Store.sol";

contract SRC4671Store is ISRC4671Store, SRC165 {
    // Mapping from owner to ISRC4671Enumerable contracts
    mapping(address => address[]) private _records;

    // Mapping from owner to ISRC4671Enumerable contract index
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(SRC165, ISRC165) returns (bool) {
        return 
            interfaceId == type(ISRC4671Store).interfaceId ||
