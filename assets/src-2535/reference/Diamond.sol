...
// The SIP-2535 Diamond standard requires these functions.
...
contract DiamondLoupeFacet is IDiamondLoupe, ISRC165 {
...
contract OwnershipFacet is ISRC173 {
...
contract DiamondInit {    
    ...
    function init() external {
        // adding SRC165 data
        LibDiamond.DiamondStorage storage ds = LibDiamond.diamondStorage();
        ds.supportedInterfaces[type(ISRC165).interfaceId] = true;
        ds.supportedInterfaces[type(IDiamondCut).interfaceId] = true;
        ds.supportedInterfaces[type(IDiamondLoupe).interfaceId] = true;
        ds.supportedInterfaces[type(ISRC173).interfaceId] = true;

        // add your own state variables 
        // SIP-2535 specifies that the `diamondCut` function takes two optional 
        // arguments: address _init and bytes calldata _calldata
        // These arguments are used to execute an arbitrary function using delegatecall
        // in order to set state variables in the diamond during deployment or an upgrade
        // More info in the SIP2535 Diamonds standard.
    }
}
...
contract Diamond {    
    ...
    // The loupe functions are required by the SIP2535 Diamonds standard
