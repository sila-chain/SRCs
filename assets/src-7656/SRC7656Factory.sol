...
import {ISRC7656Factory} from "./interfaces/ISRC7656Factory.sol";
import {ISRC165} from "./interfaces/ISRC165.sol";

import {SRC7656BytecodeLib} from "./lib/SRC7656BytecodeLib.sol";

// Mutated from https://github.com/src6551/reference
// Original authors: Jayden Windle @jaydenwindle, @vectorized
// Adapted by: Francesco Sullo @sullof

contract SRC7656Factory is ISRC165, ISRC7656Factory {
  function create(
  ...
  /// @dev Returns true if interfaceId is ISRC7656Factory.sol's interfaceId
  function supportsInterface(bytes4 interfaceId) external pure override returns (bool) {
    return interfaceId == type(ISRC7656Factory).interfaceId || interfaceId == type(ISRC165).interfaceId;
  }
}
