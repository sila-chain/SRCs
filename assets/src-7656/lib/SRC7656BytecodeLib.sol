...
// This implementation is a variation of https://github.com/src6551/reference/blob/main/src/lib/SRC6551BytecodeLib.sol
// Modified by: Francesco Sullo @sullof

library SRC7656BytecodeLib {
  /**
  ...
  function getCreationCode(
    ...
    assembly {
      // data structure
      // 0x14: src1167 header  (10 bytes)
      // 0x28: implementation  (20 bytes)
      // 0x37: src1167 footer  (15 bytes)
      // 0x77: salt            (32 bytes)
      ...
      mstore(add(result, 0x37), 0x5af43d82803e903d91602b57fd5bf3) // src1167 footer
