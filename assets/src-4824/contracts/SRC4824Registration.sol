...
/// @title SRC-4824: DAO Registration
contract SRC-4824Registration is ISRC-4824, AccessControl {
    ...
    function initialize(
        ...
        address _SRC-4824Index
    ) external {
        initialize(_daoAddress, daoURI_, _SRC-4824Index);
    ...
    function initialize(
        ...
        SRC-4824Index(_SRC-4824Index).logRegistration(address(this));
    }
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(ISRC-4824).interfaceId ||
