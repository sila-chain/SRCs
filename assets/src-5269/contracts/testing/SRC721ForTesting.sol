...
contract SRC721ForTesting is SRC721, SRC5269 {
    ...
    constructor() SRC721("SRC721ForTesting", "E721FT") SRC5269() {
        _mint(msg.sender, 0);
        emit OnSupportEIP(address(0x0), 721, bytes32(0), SIP_FINAL, "");
        emit OnSupportEIP(address(0x0), 721, keccak256("SRC721Metadata"), SIP_FINAL, "");
        emit OnSupportEIP(address(0x0), 721, keccak256("SRC721Enumerable"), SIP_FINAL, "");
    }
  ...
  returns (bytes32 eipStatus) {
    ...
    return super._supportEIP(caller, majorSIPIdentifier, minorSIPIdentifier, extraData);
  }
}
