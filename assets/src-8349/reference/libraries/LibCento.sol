...
library LibCento {
    ...
    /// @notice Target address is an SIP-7702 delegated EOA.
    ...
    /// @dev Uses the SRC-7201 storage namespace assigned to `CentoStorage`.
    ...
    /// - installing an empty contract, an EOA, or SIP-7702 delegated EOA - `_isNotEoa`.
    ...
    /// or with `Is7702EOA` for SIP-7702 delegated EOAs.
