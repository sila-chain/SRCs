...
/**
 * @title PrivacyToken
 * @notice Pure SRC-8086 privacy token implementation - the foundation layer
 * @dev This contract implements the complete IZRC20 interface with ZK-SNARK privacy features.
 *      It serves as the base layer for dual-mode tokens (SRC-8085) and can also be used
 *      standalone for pure privacy applications.
 *
 *
 * ═══════════════════════════════════════════════════════════════════════════════
 * IMPORTANT: SRC-8086 Standard vs. Reference Implementation
 * ═══════════════════════════════════════════════════════════════════════════════
 *
...
abstract contract PrivacyToken is IZRC20, ReentrancyGuard {
    ...
    /// @custom:implementation-detail Not required by SRC-8086, specific to this ZK circuit design
    ...
    /// @custom:standard-required SRC-8086 requires nullifier tracking for double-spend prevention
    mapping(bytes32 => bool) public override nullifiers;        // SRC-8086 required
    ...
    /// @custom:standard-optional SRC-8086 totalSupply() is optional but recommended
    ...
    /// @custom:standard-required SRC-8086 requires activeSubtreeRoot() for proof verification
    bytes32 public override activeSubtreeRoot;    // SRC-8086 required
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // State Variables - Business Logic (NOT part of SRC-8086 standard)
    // ═══════════════════════════════════════════════════════════════════════

    /// @dev Platform and fee configuration
    /// @custom:business-logic These are reference implementation choices, NOT required by SRC-8086
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // SRC-8086 Interface Implementation (IZRC20)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Internal: Privacy Mint (SRC-8086 Core Logic)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Internal: Privacy Transfer (SRC-8086 Core Logic)
    // ═══════════════════════════════════════════════════════════════════════
     ...
     * @dev Supports mode conversion through isModeConversion flag (for SRC-8085)
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Mode Conversion Extension Point (for SRC-8085 and other protocols)
    // ═══════════════════════════════════════════════════════════════════════

    /**
     * @notice Validate mode conversion parameters (virtual hook for derived contracts)
     * @dev Default implementation rejects mode conversion (pure SRC-8086 behavior)
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Fee Distribution (REFERENCE IMPLEMENTATION - NOT PART OF SRC-8086)
    // ═══════════════════════════════════════════════════════════════════════
