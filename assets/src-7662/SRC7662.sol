...
import "@openzeppelin/contracts/interfaces/ISRC721.sol";
import "./lib/FactoryOperatorable.sol";

contract SRC7662 is FactoryOperatorable, SRC721URIStorage {
    ...
    constructor( 
        ...
        address admin,
        address operator) SRC721("Agent NFTs", "AGENTS") FactoryOperatorable(admin, operator) {
