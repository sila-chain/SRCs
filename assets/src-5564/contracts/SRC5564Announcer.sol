...
/// @notice `SRC5564Announcer` contract to emit an `Announcement` event to broadcast information
/// about a transaction involving a stealth address. See
/// [SRC-5564](https://sips.sila.org/SIPS/sip-5564) to learn more.
contract SRC5564Announcer {
  ...
  /// [SRC-5564](https://sips.sila.org/SIPS/sip-5564) for recommendations on how to structure
  /// this metadata.
  event Announcement(
