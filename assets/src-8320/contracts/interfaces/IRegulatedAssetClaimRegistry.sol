...
/// @param author Signer (EOA or SRC-1271 contract).
...
interface IRegulatedAssetClaimRegistry is ISRC165 {
    ...
    /// @dev Signature is verified against `claim.author` over the SIP-712 Propose digest.
    ...
    /// @param signature Signature from `claim.author` (SIP-712, SIP-1271 supported).
