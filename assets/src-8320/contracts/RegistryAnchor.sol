...
/// @notice Reference implementation of the SRC-8320 asset side. An asset inherits this to approve the
///         registries that hold claims about it. Registry approval is gated to the owner.
contract RegistryAnchor is IRegistryAnchor, SRC165, Ownable {
