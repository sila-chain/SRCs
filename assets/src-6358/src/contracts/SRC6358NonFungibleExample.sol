...
import "./interfaces/ISRC6358NonFungible.sol";
...
/**
 * @notice Implementation of the {ISRC6358NonFungible} interface
 */
contract SRC6358NonFungibleExample is Ownable, ISRC6358NonFungible, ISRC721, ISRC721Metadata {
    ...
    /**
     * @notice See {ISRC6358NonFungible-sendOmniverseTransaction}
     * Send an omniverse transaction
     */
    function sendOmniverseTransaction(SRC6358TransactionData calldata _data) external override {
        _omniverseTransaction(_data);
    }

    /**
     * @notice See {ISRC6358NonFungible-triggerExecution}
     */
    function triggerExecution() external {
        ...
        (SRC6358TransactionData storage txData, uint256 timestamp) = (cache.txData, cache.timestamp);
    ...
    /**
     * @notice See {ISRC721-safeTransferFrom}.
     */
    ...
    /**
     * @notice See {ISRC721-transferFrom}.
     */
    ...
    /**
     * @notice See {ISRC721-setApprovalForAll}.
     */
    ...
    /**
     * @notice See {ISRC721-getApproved}.
     */
    ...
    /**
     * @notice See {ISRC721-isApprovedForAll}.
     */
    ...
    /**
     * @notice See {ISRC721Metadata-name}.
     */
    ...
    /**
     * @notice See {ISRC721Metadata-symbol}.
     */
    ...
    /**
     * @notice See {ISRC721Metadata-tokenURI}.
     */
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        bytes memory ret = omniverseOwners[tokenId];
        require(keccak256(ret) != keccak256(bytes("")), "SRC721Metadata: URI query for nonexistent token");
     ...
     */
    function _checkExecution(SRC6358TransactionData memory txData) internal view {
        NonFungible memory nonFungible = decodeData(txData.payload);
        if (nonFungible.op == TRANSFER) {
    ...
    /**
     * @notice See {ISRC6358NonFungible-omniverseBalanceOf}
    ...
    /**
     * @notice See {ISRC6358NonFungible-omniverseOwnerOf}
     ...
     */
    function _omniverseTransaction(SRC6358TransactionData memory _data) internal {
    ...
    /**
     * @notice See ISRC6358NonFungible
     */
     ...
     * @notice See ISRC6358NonFungible
     */
    function getTransactionData(bytes calldata _user, uint256 _nonce) external override view returns (SRC6358TransactionData memory txData, uint256 timestamp) {
    ...
    /**
     * @notice See ISRC6358Application
     */
