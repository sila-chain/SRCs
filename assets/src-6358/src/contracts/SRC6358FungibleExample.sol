...
import "./interfaces/ISRC6358Fungible.sol";
...
/**
 * @notice Implementation of the {ISRC6358Fungible} interface
 */
contract SRC6358FungibleExample is SRC20, Ownable, ISRC6358Fungible {
     ...
     */
    constructor(uint32 _chainId, string memory _name, string memory _symbol) SRC20(_name, _symbol) {
        chainId = _chainId;
    }

    /**
     * @notice See {ISRC6358Fungible-sendOmniverseTransaction}
    ...
    /**
     * @notice See {ISRC6358Fungible-triggerExecution}
     */
    ...
    /**
     * @notice See {ISRC6358Fungible-omniverseBalanceOf}
