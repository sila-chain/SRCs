...
import "@openzeppelin/contracts-upgradeable/token/SRC721/extensions/SRC721EnumerableUpgradeable.sol";
...
import {ISRC5169} from "stl-contracts/SRC/SRC5169.sol";

contract DecentralisedRegistryNFT is
    SRC721EnumerableUpgradeable,
    UUPSUpgradeable,
    ISRC7738,
    OwnableUpgradeable
{
    ...
    function initialize(
        ...
        __SRC721_init(name, symbol);
        __SRC721Enumerable_init();
