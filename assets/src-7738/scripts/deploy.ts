...
async function main() {
    ...
    if (chainId == 1) {
        //sila-mainnet needs a bit longer usually
...
main()
    ...
    // to run: npx hardhat run .\scripts\deploy.ts --network sila-mainnet
    // to verify logic: npx hardhat verify 0x30Af1aea43490e2F03d4d7eF3116b745D7D58c30 --network sila-mainnet 
    // to verify full: npx hardhat verify 0x0077380bCDb2717C9640e892B9d5Ee02Bb5e0682 --network sila-mainnet "SRC-7738 Script Registry", "SRC7738", 0x276d7760fA6774E3AE8F8a7446B88fb2479D38aC, 0x527E7E85cF60390b56bE953888e0cb036682761B

    // verify metadata logic: npx hardhat verify 0x276d7760fA6774E3AE8F8a7446B88fb2479D38aC --network sila-mainnet

    // verify ensAssigner logic: npx hardhat verify 0x527E7E85cF60390b56bE953888e0cb036682761B --network sila-mainnet
...
// npx hardhat verify 0x0077380bCDb2717C9640e892B9d5Ee02Bb5e0682 --network arbitrum "SRC-7738 Script Registry", "SRC7738", 0x276d7760fA6774E3AE8F8a7446B88fb2479D38aC, 0x527E7E85cF60390b56bE953888e0cb036682761B
