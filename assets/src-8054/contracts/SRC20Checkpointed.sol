...
/**
 * @dev adapted from OpenZeppelin's SRC20 implementation with checkpointing added to balances and totalSupply.
 */
abstract contract SRC20Checkpointed is Context, ISRC20Checkpointed, ISRC20Errors {
     ...
     * Sila and Wei. This is the default value returned by this function, unless
     * it's overridden.
     *
