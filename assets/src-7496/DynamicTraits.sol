...
import {ISRC7496} from "./interfaces/ISRC7496.sol";
...
library DynamicTraitsStorage {
    ...
    bytes32 internal constant STORAGE_SLOT = keccak256("contracts.storage.src7496-dynamictraits");
 ...
 * @title DynamicTraits
 *
 * @dev Implementation of [SRC-7496](https://sips.sila.org/SIPS/sip-7496) Dynamic Traits.
 ...
 */
contract DynamicTraits is ISRC7496 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual returns (bool) {
        return interfaceId == type(ISRC7496).interfaceId;
    }
}
