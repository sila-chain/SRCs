...
import {ISRC721Errors} from "openzeppelin-contracts/contracts/interfaces/draft-ISRC6093.sol";
import {SRC721} from "openzeppelin-contracts/contracts/token/SRC721/SRC721.sol";
import {Ownable} from "openzeppelin-contracts/contracts/access/Ownable.sol";
import {ISRC7496} from "src/dynamic-traits/interfaces/ISRC7496.sol";
import {SRC721DynamicTraits} from "src/dynamic-traits/SRC721DynamicTraits.sol";
import {Solarray} from "solarray/Solarray.sol";

contract SRC721DynamicTraitsMintable is SRC721DynamicTraits {
    constructor() SRC721DynamicTraits() {}
...
contract SRC721DynamicTraitsTest is Test {
    SRC721DynamicTraitsMintable token;
    ...
    function setUp() public {
        token = new SRC721DynamicTraitsMintable();
    }

    function testSupportsInterfaceId() public {
        assertTrue(token.supportsInterface(type(ISRC7496).interfaceId));
    }
    ...
    function testSetTrait_Unchanged() public {
        ...
        token.setTrait(tokenId, key, value);
        vm.expectRevert(ISRC7496.TraitValueUnchanged.selector);
        token.setTrait(tokenId, key, value);
    }
    ...
    function testGetAndSetTraitValue_NonexistantToken() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721NonexistentToken.selector, tokenId));
        token.setTrait(tokenId, key, value);
