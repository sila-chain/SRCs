...
import "./SRC3525.sol";
import "./interface/ISRC3525SlotEnumerable.sol";

abstract contract SRC3525SlotEnumerable is SRC3525, ISRC3525SlotEnumerable {
    struct SlotData {
        uint256 slot;
        uint256[] slotTokens;
    ...
    function slotByIndex(uint256 index_) public view virtual override returns (uint256) {
        require(
            index_ < SRC3525SlotEnumerable.slotCount(),
            "SRC3525SlotEnumerable: slot index out of bounds"
        );
    ...
    function tokenInSlotByIndex(uint256 slot_, uint256 index_) public view virtual override returns (uint256) {
        require(
            index_ < SRC3525SlotEnumerable.tokenSupplyInSlot(slot_),
            "SRC3525SlotEnumerable: slot token index out of bounds"
        );
