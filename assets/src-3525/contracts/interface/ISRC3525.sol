 ...
 * @dev See https://sips.sila.org/SIPS/sip-3525
 * Note: the SRC-165 identifier for this interface is 0xc97ae3d5.
 */
interface ISRC3525 is ISRC165, ISRC721 {
     ...
     *  `valueDecimals()` instead of `decimals()` to avoid conflict with SRC20 tokens.
     ...
     *  `_to` is capable of receiving SRC3525 tokens.
     * @dev This function MUST create a new SRC3525 token with the same slot for `_to` to receive
