 ...
 */
contract SRC3525Example is SRC3525 {
    ...
    constructor( string memory name_, string memory symbol_, uint8 decimals_) SRC3525(name_, symbol_, decimals_) {}
    ...
    function mint( string memory slotName_, string memory slotDescription_, string memory slotImage_,
        ...
        require(tokenId_ < _externalMintMaxId, "SRC3525: tokenId is too large");
        ...
        SRC3525._mintValue(_msgSender(), tokenId_, slot, value_);
    }
