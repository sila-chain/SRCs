 ...
 * @notice Factory for deploying new SRC-8086 compliant privacy tokens
 * @dev Uses minimal proxy pattern (SIP-1167) for gas-efficient deployments.
...
contract PrivacyTokenFactory is Ownable {
     ...
     * @param mintPrice Price per mint in native token (SIL)
