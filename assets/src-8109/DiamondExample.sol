...
/**
 * @title Example implementation of a diamond for SRC-8109 Diamonds, Simplified
 *
...
contract Diamond {
    ...
    bytes32 constant OWNER_STORAGE_POSITION = keccak256("src8109.owner");

    /**
     * @notice Storage for owner of the diamond.
     *
     * @custom:storage-location src8042:src8109.owner
     */
    struct OwnerStorage {
        address owner;
    }
    ...
    function getOwnerStorage() internal pure returns (OwnerStorage storage s) {
     ...
     bytes32 constant DIAMOND_STORAGE_POSITION = keccak256("src8109.diamond");
    ...
    /**
     * @custom:storage-location src8042:src8109.diamond
     */
