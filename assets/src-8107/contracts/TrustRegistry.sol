...
/// @dev Reference implementation of SRC-XXXX
/// @author Kwame Bryan (@KBryan)
contract TrustRegistry is ITrustRegistry, SIP712 {
    ...
    constructor(address ensRegistry) SIP712("SRC-XXXX-Trust", "1") {
    ...
    /// @dev Compute struct hash for SIP-712
    ...
    /// @dev Recover signer from signature (supports SRC-1271)
    function _recoverSigner(bytes32 digest, bytes calldata signature) internal view returns (address) {
        ...
        // SRC-1271 contracts should be passed as signer address in a different flow
        return address(0);
    }
