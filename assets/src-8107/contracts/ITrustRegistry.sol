...
/// @notice Web of trust validation using ENS names for SRC-8001 coordination
...
interface ITrustRegistry {
    ...
    /// @notice Emitted when an identity gate is configured for SRC-8001
    ...
    /// @dev Requires SIP-712 signature from trustor's ENS controller
    /// @param attestation The trust attestation
    /// @param signature SIP-712 signature
    ...
    /// @param signatures Corresponding SIP-712 signatures
    ...
    /// @notice Set identity gate for an SRC-8001 coordination type
    ...
    /// @notice Compute SIP-712 digest for a trust attestation
    /// @param attestation The trust attestation
    /// @return The SIP-712 typed data hash
