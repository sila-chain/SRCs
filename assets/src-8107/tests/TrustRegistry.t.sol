...
contract TrustRegistryTest is Test {
    ...
    bytes32 aliceNode = keccak256("alice.sil");
    bytes32 bobNode = keccak256("bob.sil");
    bytes32 carolNode = keccak256("carol.sil");
    bytes32 daveNode = keccak256("dave.sil");
    bytes32 eveNode = keccak256("eve.sil");
    ...
    function test_RevertWhen_ENSNameNotFound() public {
        bytes32 unknownNode = keccak256("unknown.sil");
