...
contract DeedRegistry is SRC721Enumerable, Bequeathable {
   ...
   function supportsInterface(bytes4 interfaceId) public view override(SRC721Enumerable) returns (bool) {
      return super.supportsInterface(interfaceId);
   }

   constructor() SRC721("MyDeeds", "MYD") {
   ...
   function bequeath(address owner) public{
      ...
      for (uint256 i = 0; i < tokenCount; i++) {
         ...
         super.transferFrom(owner, will.inheritor, tokenId); // Standard SRC721 transfer.
      }
