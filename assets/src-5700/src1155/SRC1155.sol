...
import {ISRC1155Errors} from "../interfaces/ISRC1155Errors.sol";

/// @title Dopamine Minimal SRC-1155 Contract
/// @notice This is a minimal SRC-1155 implementation that 
contract SRC1155 is ISRC1155, ISRC1155Errors {
    ...
    bytes4 private constant _SRC1155_INTERFACE_ID = 0xd9b67a26;
    ...
    function safeTransferFrom(
        ...
        if (
            to.code.length != 0 &&
            ISRC1155Receiver(to).onSRC1155Received(
                msg.sender,
                address(0),
                id,
                amount,
    ...
    function safeBatchTransferFrom(
        ...
        if (
            to.code.length != 0 &&
            ISRC1155Receiver(to).onSRC1155BatchReceived(
                msg.sender,
                from,
                ids,
                amounts,
