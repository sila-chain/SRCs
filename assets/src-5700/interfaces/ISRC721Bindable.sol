...
import {ISRC721BindableErrors} from "./ISRC721BindableErrors.sol";

/// @title SRC-721 Bindable Token Standard
/// @dev See https://sips.sila.org/SIPS/sip-5700
///  Note: the SRC-165 identifier for this interface is 0x82a34a7d.
interface ISRC721Bindable is ISRC721, ISRC721BindableErrors {
