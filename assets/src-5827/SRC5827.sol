...
contract SRC5827 is SRC20, ISRC5827 {
    ...
    function approve(
        address _spender,
        uint256 _value
    ) public override(SRC20, ISRC5827) returns (bool success) {
    ...
    function allowance(
        address _owner,
        address _spender
    ) public view override(SRC20, ISRC5827) returns (uint256 remaining) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 amount
    ) public override(SRC20, ISRC5827) returns (bool) {
    ...
    function supportsInterface(
        ...
        return interfaceId == type(ISRC5827).interfaceId;
    }
}
