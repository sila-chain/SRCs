...
/// @title Interface for ISRC5827 contracts
/// @notice Please see https://sips.sila.org/SIPS/sip-5827 for more details on the goals of this interface
/// @author Zac (zlace0x), zhongfu (zhongfu), Edison (edison0xyz)
interface ISRC5827 is ISRC20, ISRC165 {
