...
contract SRC7891 is SRC6150, ISRC7891 {
    ...
    constructor() SRC6150("SRC7891", "NFT") {}
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(SRC721, ISRC165) returns (bool) {
     return 
     interfaceId == type(ISRC7891).interfaceId || super.supportsInterface(interfaceId);
     }

    function getInterfaceID() external pure returns (bytes4) {
        return type(ISRC7891).interfaceId;
     }
  }
