...
/**
    @title A test to verify that the UCS Contracts meet the specifications of the SRC-7546 standard.
 */
...
/// @dev A storage layout library that complies with SRC-7201
library Storage {
    /// @custom:storage-location src7201:ucs.number
    struct Number {
        uint256 number;
    }
