...
/**
 *  @title A test to verify that the Dictionary Contract meets the specifications of the SRC-7546 standard.
 *
 *  Dictionary Specs
 ...
 *    (3) supportsInterface(bytes4 interfaceID) defined in SRC-165
