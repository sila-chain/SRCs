...
import "../abstracts/SRC8047.sol";
import "../policies/FreezeAddress.sol";
import "../policies/FreezePartialTokens.sol";
import "../policies/TPEn.sol";

contract MockSRC8047 is SRC8047, FreezeAddress, FreezePartialTokens, AbstractTokenPolicyEnforcement {
    constructor(string memory uri_) SRC8047(uri_) {}

    // -----------------------------------------------------------------------
    // Advanced Forensic Freezing Rules (Examples)
    // -----------------------------------------------------------------------
    // The following patterns demonstrate how sophisticated enforcement logic
    // can be layered on top of the base SRC8047 DAG structure:
