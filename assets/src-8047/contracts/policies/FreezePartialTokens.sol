...
abstract contract FreezePartialTokens {
    ...
    /**  @custom:events */
    /**
     * @dev See {ISRC3643.TokensFrozen}.
     * @custom:reference {https://github.com/SRC-3643/SRC-3643/blob/main/contracts/token/IToken.sol}
     */
    event TokensFrozen(address indexed userAddress, uint256 value);

    /**
     * @dev See {ISRC3643.TokensUnFrozen}.
     * @custom:reference {https://github.com/SRC-3643/SRC-3643/blob/main/contracts/token/IToken.sol}
     */
    ...
    /**
     * @dev See {ISRC3643.freezePartialTokens}
     * @custom:reference
     * {https://sips.sila.org/SIPS/sip-3643}.
     * {https://docs.src3643.org/src-3643/smart-contracts-library/permissioned-tokens/tokens-interface}.
     */
    ...
    /**
     * @dev See {ISRC3643.unfreezePartialTokens}
     * @custom:reference
     * {https://sips.sila.org/SIPS/sip-3643}.
     * {https://docs.src3643.org/src-3643/smart-contracts-library/permissioned-tokens/tokens-interface}.
     */
