...
import "./interfaces/ISRC165.sol";
import "./interfaces/ISRC5289Library.sol";

contract SRC5289Library is ISRC165, ISRC5289Library {
    ...
    function supportsInterface(bytes4 _interfaceId) public view returns (bool) {
        return _interfaceId == type(ISRC5289Library).interfaceId;
    }
}
