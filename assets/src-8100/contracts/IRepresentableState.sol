 ...
 *
 *      The normative specification is defined in SRC-8100.
 *      If there is any mismatch, the SRC text is authoritative.
 *
 ...
 * @dev The JSON binding schema and version are out of scope for this SRC. Snapshot consistency
