...
contract InterestRateSwapSettleToMarket is IXMLRepresentableStateVersionedHashed {
    ...
    function stateXmlTemplate() external pure override returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                "            </fpml:partyTradeIdentifier>"
                "            <fpml:tradeDate svmstate:call='tradeDate()(uint256)' svmstate:format='iso8601-date'/>"
                "        </fpml:tradeHeader>"
                ""
                "        <fpml:party id='PartyA'>"
                "            <fpml:partyId svmstate:call='partyALEI()(string)'/>"
                "        </fpml:party>"
                "        <fpml:party id='PartyB'>"
                "            <fpml:partyId svmstate:call='partyBLEI()(string)'/>"
                "        </fpml:party>"
                ""
                "        <fpml:swap>"
                "            <!-- FIXED LEG -->"
                ...
                "                    <fpml:currency svmstate:call='currency()(string)'/>"
                "                    <fpml:amount svmstate:call='notional()(uint256)' svmstate:format='decimal' svmstate:scale='2'/>"
                "                </fpml:calculationAmount>"
                "                <fpml:calculationPeriodDates>"
                "                    <fpml:effectiveDate>"
                "                        <fpml:unadjustedDate svmstate:call='effectiveDate()(uint256)' svmstate:format='iso8601-date'/>"
                "                    </fpml:effectiveDate>"
                "                    <fpml:terminationDate>"
                "                        <fpml:unadjustedDate svmstate:call='terminationDate()(uint256)' svmstate:format='iso8601-date'/>"
                "                    </fpml:terminationDate>"
                "                </fpml:calculationPeriodDates>"
                ...
                "                            <fpml:initialValue svmstate:call='fixedRateBP()(int256)' svmstate:format='decimal' svmstate:scale='4'/>"
                "                        </fpml:fixedRateSchedule>"
                "                    </fpml:calculation>"
                "                </fpml:calculationPeriodAmount>"
                "            </fpml:swapStream>"
                ...
                "                            </fpml:indexTenor>"
                "                            <fpml:spreadSchedule>"
                "                                <fpml:initialValue svmstate:call='floatSpreadBP()(int256)' svmstate:format='decimal' svmstate:scale='4'/>"
                "                            </fpml:spreadSchedule>"
                "                        </fpml:floatingRateCalculation>"
                "                    </fpml:calculation>"
                "                </fpml:calculationPeriodAmount>"
    ...
    function _settlementsFragment() internal pure returns (string memory) {
        return
                    "    <LastSettlement>"
                    "        <time  svmstate:call='lastSettlementTime()(uint256)' svmstate:format='iso8601-datetime'/>"
                    "        <value svmstate:call='lastSettlementValue()(int256)' svmstate:format='decimal' svmstate:scale='2'/>"
                    "        <count svmstate:call='settlementCount()(uint256)' svmstate:format='integer'/>"
                    "    </LastSettlement>"
                    ""
                    "    <History"
                    "        svmstate:call='settlementHistory()(tuple(uint256,int256)[])'"
                    "        svmstate:item-element='Settlement'>"
                    "        <Settlement>"
                    "            <time"
                    "                svmstate:item-field='0'"
                    "                svmstate:format='iso8601-datetime'/>"
                    "            <value"
