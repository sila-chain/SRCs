...
contract InterestRateSwapSettleToMarket is IXMLRepresentableStateVersionedHashed {
    ...
    function stateXmlTemplate() external pure override returns (string memory) {
        ...
        return string(
            abi.encodePacked(
                ...
                "            </fpml:partyTradeIdentifier>"
                "            <fpml:tradeDate savmstate:call='tradeDate()(uint256)' savmstate:format='iso8601-date'/>"
                "        </fpml:tradeHeader>"
                ""
                "        <fpml:party id='PartyA'>"
                "            <fpml:partyId savmstate:call='partyALEI()(string)'/>"
                "        </fpml:party>"
                "        <fpml:party id='PartyB'>"
                "            <fpml:partyId savmstate:call='partyBLEI()(string)'/>"
                "        </fpml:party>"
                ""
                "        <fpml:swap>"
                "            <!-- FIXED LEG -->"
                ...
                "                    <fpml:currency savmstate:call='currency()(string)'/>"
                "                    <fpml:amount savmstate:call='notional()(uint256)' savmstate:format='decimal' savmstate:scale='2'/>"
                "                </fpml:calculationAmount>"
                "                <fpml:calculationPeriodDates>"
                "                    <fpml:effectiveDate>"
                "                        <fpml:unadjustedDate savmstate:call='effectiveDate()(uint256)' savmstate:format='iso8601-date'/>"
                "                    </fpml:effectiveDate>"
                "                    <fpml:terminationDate>"
                "                        <fpml:unadjustedDate savmstate:call='terminationDate()(uint256)' savmstate:format='iso8601-date'/>"
                "                    </fpml:terminationDate>"
                "                </fpml:calculationPeriodDates>"
                ...
                "                            <fpml:initialValue savmstate:call='fixedRateBP()(int256)' savmstate:format='decimal' savmstate:scale='4'/>"
                "                        </fpml:fixedRateSchedule>"
                "                    </fpml:calculation>"
                "                </fpml:calculationPeriodAmount>"
                "            </fpml:swapStream>"
                ...
                "                            </fpml:indexTenor>"
                "                            <fpml:spreadSchedule>"
                "                                <fpml:initialValue savmstate:call='floatSpreadBP()(int256)' savmstate:format='decimal' savmstate:scale='4'/>"
                "                            </fpml:spreadSchedule>"
                "                        </fpml:floatingRateCalculation>"
                "                    </fpml:calculation>"
                "                </fpml:calculationPeriodAmount>"
    ...
    function _settlementsFragment() internal pure returns (string memory) {
        return
                    "    <LastSettlement>"
                    "        <time  savmstate:call='lastSettlementTime()(uint256)' savmstate:format='iso8601-datetime'/>"
                    "        <value savmstate:call='lastSettlementValue()(int256)' savmstate:format='decimal' savmstate:scale='2'/>"
                    "        <count savmstate:call='settlementCount()(uint256)' savmstate:format='integer'/>"
                    "    </LastSettlement>"
                    ""
                    "    <History"
                    "        savmstate:call='settlementHistory()(tuple(uint256,int256)[])'"
                    "        savmstate:item-element='Settlement'>"
                    "        <Settlement>"
                    "            <time"
                    "                savmstate:item-field='0'"
                    "                savmstate:format='iso8601-datetime'/>"
                    "            <value"
                    "                savmstate:item-field='1'"
