...
contract MultiAssetToken is Context, ISRC721, ISRC5773 {
    ...
    function balanceOf(
        ...
        require(
            owner != address(0),
            "SRC721: address zero is not a valid owner"
        );
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId);
        require(
            _checkOnSRC721Received(from, to, tokenId, data),
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(
            _checkOnSRC721Received(address(0), to, tokenId, data),
            "MultiAsset: transfer to non SRC721 Receiver implementer"
        );
    }
