...
/// @title SRC8063 — Reference implementation of a membership token (Group)
/// @notice A standard SRC-20 token with optional membership introspection
/// @dev Any SRC-20 can be a Group; this reference adds the ISRC8063 interface
contract SRC8063 is ISRC8063 {
    ...
    /// @param groupName Human-readable group name (SRC-20 name)
    /// @param groupSymbol Token symbol (SRC-20 symbol)
    ...
    function supportsInterface(bytes4 interfaceId) external pure returns (bool) {
        return
            interfaceId == type(ISRC8063).interfaceId ||
            interfaceId == 0x36372b07 || // SRC-20
            interfaceId == 0x01ffc9a7;   // SRC-165
    }
