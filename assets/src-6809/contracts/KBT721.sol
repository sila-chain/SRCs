...
import "./IKBT721.sol";
import "../node_modules/@openzeppelin/contracts/token/SRC721/extensions/SRC721Enumerable.sol";
import "../node_modules/@openzeppelin/contracts/access/Ownable.sol";

contract KBT721 is IKBT721, SRC721Enumerable, Ownable {
    ...
    // region SRC721 overrides

    function transferFrom(
        address _from,
        address _to,
        uint256 _tokenId
    ) public virtual override(SRC721, ISRC721) {
