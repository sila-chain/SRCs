...
contract('FirstKBT', (accounts) => {
  ...
  it("17. transferFrom : spenderAccount CANNOT transferFrom accountHolder without Approval", function () {
    tokenId = 34;
    expectRevert(instance.transferFrom(accountHolder, secondAccountHolder, tokenId, { from: spenderAccount }), "SRC721: caller is not token owner or approved");
  });
  ...
  it("21. transferFrom: spenderAccount CAN transferFrom accountHolder but no more than he's allowed", async function () {
    ...
    expectRevert(instance.transferFrom(accountHolder, secondAccountHolder, tempTokenIds[i], { from: spenderAccount }), "SRC721: caller is not token owner or approved");
  });
