...
/// @notice The attestation a consumed verdict hands off to SRC-8004's Validation Registry, so a
...
struct VerdictAttestation {
    ...
    bytes32 policyRoot;   // SRC-7812 root of the committed (undisclosed) policy the decision used
...
library PolicyAttestation {
    ...
    /// @notice Canonical attestation for a consumed verdict — the payload written to SRC-8004.
...
/// @notice Minimal view of the SRC-8004 Validation Registry write target used by a guarded contract
