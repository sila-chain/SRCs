...
contract ECDSAFrameValidator is IFrameValidator {
    ...
    // SRC-8286 frame validator module type id (TBD in the draft). A module MAY additionally
    // be an SRC-7579 validator (type id 1) and serve both targets; this one serves only the
    // SIP-8141 frame flow.
