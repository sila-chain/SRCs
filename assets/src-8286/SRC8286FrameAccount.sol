...
import {ISRC8286FrameAccount} from "./ISRC8286FrameAccount.sol";

// ISRC7579Module, and the ISRC7579AccountConfig / ISRC7579ModuleConfig surfaces inherited
// via ISRC8286FrameAccount, are as defined in SRC-7579.

contract SRC8286FrameAccount is ISRC8286FrameAccount {
    ...
    // SIP-8141 frame modes (FRAMEPARAM param 0x02).
    uint256 internal constant MODE_VERIFY = 1;
    uint256 internal constant MODE_SENDER = 2;

    // SRC-8286 assigns frame validators a new module type id, distinct from SRC-7579's
    ...
    // SRC-7579's encoding with two new values; execType keeps its SRC-7579 meaning.
        ...
        onlySelf
    {
        ...
        ISRC7579Module(module).onInstall(initData);
        ...
        onlySelf
    {
        ...
        ISRC7579Module(module).onUninstall(deInitData);
    ...
    function accountId() external pure override returns (string memory) {
        return "src8286.reference-frame-account.0.1.0";
    }
    ...
    // to authorize, using the frame execution modes (callType 0x02 / 0x03). SRC-7579 execute
