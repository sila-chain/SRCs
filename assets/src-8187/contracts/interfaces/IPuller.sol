...
/**
 * @title IPuller
 * @notice Interface for the SRC-8187 Token Puller standard.
 *
 ...
 * - Off-chain SIP-712 signed permits
 ...
 *
 * @custom:specification https://sips.sila.org/SRCS/src-8187
 */
interface IPuller {
    // =============================================================
    // Events
    ...
    /**
     * @notice Approves or updates a pull allowance using an off-chain SIP-712 signature.
     ...
     * @param signature The SIP-712 signature (r,s,v for EOA; TODO: SRC-6492/SRC-1271 support)
     */
    function permitPull(
        address token,
        address owner,
     ...
     * @param signature The SIP-712 signature
     */
    ...
    // =============================================================
    // SIP-5267 / SIP-2612 helpers
    // =============================================================

    /**
     * @notice Returns the SIP-712 domain data per SRC-5267.
