 ...
 * permit, and event emission logic of SRC-8187.
 *
 ...
 */
abstract contract BasePuller is IPuller, SIP712 {
    ...
    constructor() SIP712("TokenPuller", "1") {}
    ...
    {
        return (hex"0f", _SIP712Name(), _SIP712Version(), block.chainid, address(this), bytes32(0), new uint256[](0));
    }
