...
import {ISRC4626} from "@openzeppelin/contracts/interfaces/ISRC4626.sol";
 ...
 * 1. Transfers vault shares from the owner (via the SRC-20 allowance)
 ...
 * // Owner approves vault shares to SRC4626Puller.
 ...
 * ```
 */
contract SRC4626Puller is BasePuller {
    // =============================================================
    // State
    // =============================================================

    /// @notice The SRC-4626 vault this puller is paired with.
    ISRC4626 public immutable vault;
    ...
    /**
     * @notice Configures the puller for a single SRC-4626 vault.
     * @param vault_ The SRC-4626 vault address
     */
    constructor(ISRC4626 vault_) {
        vault = vault_;
        asset = vault_.asset();
    }
