...
import "./interfaces/ISIP6366Error.sol";
import "./interfaces/ISIP6366Core.sol";

/**
 * @dev Implement the core of SIP-6366
 */
contract SIP6366Core is ISIP6366Core {
    /**
    ...
    function _transfer(
        ...
        if (permissions[_to] & _permission > 0) {
            revert ISIP6366Error.DuplicatedPermission(_permission);
        }
