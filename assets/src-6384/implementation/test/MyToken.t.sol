...
import {MyToken, IEvalSIP712Buffer} from "src/MyToken/MyToken.sol";
...
contract MyTokenTest is Test {
    ...
    function testEvalSIP712BufferTransfer() public view {
        ...
        string[] memory translatedSig = myToken.evalSIP712Buffer(myToken.DOMAIN_SEPARATOR(), "Transfer", encodedTransfer);
