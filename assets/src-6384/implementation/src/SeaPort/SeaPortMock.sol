...
import "src/IEvalSIP712Buffer.sol";
...
contract SeaPortMock is IEvalSIP712Buffer {
    address public immutable sip712TransalatorContract;
    ...
    constructor(address _translator) {
        sip712TransalatorContract = _translator;
    }
    ...
    function evalSIP712Buffer(
        ...
        return SeaPort712ParserHelper(sip712TransalatorContract).parseSig(encodedSignature);
    }
