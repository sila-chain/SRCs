...
| File | Purpose |
|------|---------|
| [`contracts/ISRC7303.sol`](./contracts/ISRC7303.sol) | The introspection interface from the SRC text |
| [`contracts/SRC7303.sol`](./contracts/SRC7303.sol) | The reference implementation from the SRC text |
| [`contracts/FixtureTarget.sol`](./contracts/FixtureTarget.sol) | Compliant fixture with a fixed, canonical role structure |
| [`contracts/LegacyTarget.sol`](./contracts/LegacyTarget.sol) | Negative fixture: identical balance gating, no `ISRC7303` |
| [`contracts/SRC721ControlToken.sol`](./contracts/SRC721ControlToken.sol) | Minimal issuer-burnable SRC-721 control token |
| [`contracts/SRC1155ControlToken.sol`](./contracts/SRC1155ControlToken.sol) | Minimal issuer-burnable SRC-1155 control token |
