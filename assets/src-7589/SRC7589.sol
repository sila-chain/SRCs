...
import { SRC1155Holder, SRC1155Receiver } from '@openzeppelin/contracts/token/SRC1155/utils/SRC1155Holder.sol';
import { SRC165Checker } from '@openzeppelin/contracts/utils/introspection/SRC165Checker.sol';

// Semi-fungible token (SFT) roles registry
contract SftRolesRegistry is ISftRolesRegistry, SRC1155Holder, ICommitTokensAndGrantRoleExtension {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(SRC1155Receiver, ISRC165) returns (bool) {
        return
    ...
    function _transferFrom(
        ...
        ISRC1155(_tokenAddress).safeTransferFrom(_from, _to, _tokenId, _tokenAmount, '');
    }
