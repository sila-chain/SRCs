...
contract ABT is SRC721A, AccessControl  {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(SRC721A, AccessControl) returns (bool) {
    ...
    SRC721A("Account-Bound Token", "ABT") {
