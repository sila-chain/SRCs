...
/** Excluding base SRC-721 tests as they inherit from OpenZeppelin. */

describe("SRC-7858 Base", function () {
  ...
  it("supportsInterface SRC-721", async function () {
    expect(await tokenContract.supportsInterface("0x80ac58cd")).to.equal(true);
  });

  it("supportsInterface SRC-7858", async function () {
