...
import "./interface/ISRC20.sol";
import "./math/SafeMath.sol";

/**
 * @title Standard RFT(SRC1633) token extending SRC20
 *
 * @dev Implementation of the basic standard token.
 * https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-20.md
