...
import {ISRC7508} from "./ISRC7508.sol";

/**
 * @title SRC-7508 Public On-Chain NFT Attributes Repository
 * @author Steven Pineda, Jan Turk
 * @notice Implementation smart contract of the SRC-7508 Public On-Chain NFT Attributes Repository
 */
contract AttributesRepository is ISRC7508, Context {
    bytes32 public immutable DOMAIN_SEPARATOR =
        keccak256(
            abi.encode(
                "SRC-7508: Public On-Chain NFT Attributes Repository",
                "1",
                block.chainid,
                address(this)
            )
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(ISRC7508).interfaceId ||
    ...
    function _checkOnlyAuthorizedCaller(
        ...
        if (
            ...
            ISRC721(collection).ownerOf(tokenId) != caller
        ) {
