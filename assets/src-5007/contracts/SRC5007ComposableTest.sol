...
import "./SRC5007Composable.sol";

contract SRC5007ComposableTest is SRC5007Composable  {
    ...
    /**
     * @dev Returns the interfaceId of ISRC5007Composable.
     */
    function getInterfaceId() public pure returns (bytes4) {
        return type(ISRC5007Composable).interfaceId;
    }    
}
