...
abstract contract SRC5007 is SRC721, ISRC5007 {
    struct TimeNftInfo {
        uint64 startTime;
        uint64 endTime;
    }
    ...
    function _mintTimeNft(
        ...
        require(endTime_ >= startTime_, 'SRC5007: invalid endTime');
        _mint(to_, tokenId_);
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool) {
        return
            interfaceId == type(ISRC5007).interfaceId ||
