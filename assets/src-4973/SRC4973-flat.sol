...
library Strings {
    ...
    function toString(uint256 value) internal pure returns (string memory) {
        ...
        // https://github.com/oraclize/sila-api/blob/b42146b063c7d6ee1358846c198246239e9360e8/oraclizeAPI_0.4.25.sol
...
library ECDSA {
     ...
     *
     * See https://sips.sila.org/SIPS/sip-2098[SIP-2098 short signatures]
     *
     * _Available since v4.3._
     */
    function tryRecover(
    ...
    /**
     * @dev Returns an Sila Signed Typed Data, created from a
...
library Address {
     ...
     *
     * https://sips.sila.org/SIPS/sip-1884[SIP1884] increases the gas cost
     ...
     * Requirements:
     *
     * - the calling contract must have an SIL balance of at least `value`.
 ...
 * signatures from externally owned accounts (EOAs) as well as SRC1271 signatures from smart contract wallets like
...
library SignatureChecker {
     ...
     * signature is validated against that smart contract using SRC1271, otherwise it's validated using `ECDSA.recover`.
     *
    ...
    function isValidSignatureNow(
        ...
        (bool success, bytes memory result) = signer.staticcall(
            abi.encodeWithSelector(ISRC1271.isValidSignature.selector, hash, signature)
        );
        return (success &&
            result.length == 32 &&
            abi.decode(result, (bytes32)) == bytes32(ISRC1271.isValidSignature.selector));
    }
}

// OpenZeppelin Contracts v4.4.1 (utils/cryptography/draft-SIP712.sol)

/**
 * @dev https://sips.sila.org/SIPS/sip-712[SIP 712] is a standard for hashing and signing of typed structured data.
 *
 * The encoding specified in the SIP is very generic, and such a generic implementation in Solidity is not feasible,
 * thus this contract does not implement the encoding itself. Protocols need to implement the type-specific encoding
 * they need in their contracts using a combination of `abi.encode` and `keccak256`.
 *
 * This contract implements the SIP 712 domain separator ({_domainSeparatorV4}) that is used as part of the encoding
...
abstract contract SIP712 {
     ...
     * https://sips.sila.org/SIPS/sip-712#definition-of-domainseparator[SIP 712]:
     *
...
// OpenZeppelin Contracts v4.4.1 (utils/introspection/SRC165.sol)

// OpenZeppelin Contracts v4.4.1 (utils/introspection/ISRC165.sol)

/**
 * @dev Interface of the SRC165 standard, as defined in the
 * https://sips.sila.org/SIPS/sip-165[SIP].
 *
 * Implementers can declare support of contract interfaces, which can then be
 * queried by others ({SRC165Checker}).
 *
 * For an implementation, see {SRC165}.
 */
interface ISRC165 {
    /**
     * @dev Returns true if this contract implements the interface defined by
     * `interfaceId`. See the corresponding
     * https://sips.sila.org/SIPS/sip-165#how-interfaces-are-identified[SIP section]
 ...
 *
 * Contracts that want to implement SRC165 should inherit from this contract and override {supportsInterface} to check
 ...
 * ```
 *
 * Alternatively, {SRC165Storage} provides an easier to use but more expensive implementation.
 */
abstract contract SRC165 is ISRC165 {
    /**
...
/// @notice Reference implementation of SIP-4973 tokens.
/// @author Tim Daubenschütz, Rahul Rumalla (https://github.com/rugpullindex/SRC4973/blob/master/src/SRC4973.sol)
abstract contract SRC4973 is SIP712, SRC165, ISRC721Metadata, ISRC4973 {
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    returns (bool)
  {
    return interfaceId == type(ISRC721Metadata).interfaceId
      || interfaceId == type(ISRC4973).interfaceId
