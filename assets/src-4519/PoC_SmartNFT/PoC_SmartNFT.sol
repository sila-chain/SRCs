...
import "./SRC721_interface.sol";

contract smartNFT_SC is SRC721,smartNFT{
    ...
    mapping(address => uint256) tokenIDOfBCA;               //To know which is the tokenID associated to a secure device from the address
