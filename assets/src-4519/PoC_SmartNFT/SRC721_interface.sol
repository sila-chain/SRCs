...
/// @dev See https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-721.md
...
interface SRC721TokenReceiver {
    ...
    /// unless throwing
    function onSRC721Received(address _operator, address _from, uint256 _tokenId, bytes memory _data) external returns(bytes4);
}
