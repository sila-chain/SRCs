...
interface IAgentMandate is ISRC165 {
    ...
    ///      via SignatureChecker against the GrantMandate SIP-712 digest.
    /// @param params The mandate parameters.
    /// @param signature Principal signature (SIP-712, SIP-1271 supported).
    ...
    /// @notice Returns the SIP-712 domain separator.
