...
contract AgentMandateTest is Test {
    ...
    bytes32 constant ACTION = bytes32(ISRC20.transferFrom.selector);
    ...
    function test_GrantByContractWallet_SIP1271() public {
    ...
    function test_SupportsInterface() public view {
        ...
        assertTrue(mandate.supportsInterface(type(ISRC165).interfaceId));
