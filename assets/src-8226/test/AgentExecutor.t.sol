...
import {ISRC7943Fungible} from "../contracts/regulated-asset-mock/ISRC7943.sol";
...
contract AgentExecutorTest is Test {
    ...
    bytes4 constant TRANSFER_FROM = ISRC20.transferFrom.selector;
    bytes4 constant APPROVE = ISRC20.approve.selector;
    ...
    function test_TokenComplianceBlocksIndependently() public {
        bytes memory inner = abi.encodeWithSelector(ISRC7943Fungible.SRC7943CannotReceive.selector, stranger);
        vm.prank(agent);
