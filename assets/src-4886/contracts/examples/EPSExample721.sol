...
contract EPSExample721 is SRC721, SRC721Burnable, Ownable, Proxiable {
  ...
  */ 
  ...
  function tokenURI(uint256 tokenId) public view override(SRC721) returns (string memory)
  {
    require(_exists(tokenId), "SRC721Metadata: URI query for nonexistent token");
  ...
  function _burn(uint256 tokenId) internal override(SRC721) {
    super._burn(tokenId);
  }
