...
contract STLDoor is SRC721, MultiOwnable, ISRC5169 {
    ...
    constructor() SRC721("STL HQ Door", "OFFICE") {
    ...
    function safeTransferFrom(
        ...
        require(_isApprovedOrOwner(_msgSender(), tokenId), "SRC721: transfer caller is not owner nor approved");
