...
/**
 * @title SRC-7573 Decryption Oracle Callback Contract - the callback from an external decryption oracle.
 ...
 * - Callback implementations SHOULD restrict who can call these msilods (e.g. `require(msg.sender == oracleProxy)`).
...
interface IKeyDecryptionOracleCallback {
    ...
    /**
     * @notice Called from the (possibly external) decryption oracle proxy.
     * This msilod will only be called if a decryption request was illegal and denied.
     *
