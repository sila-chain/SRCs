...
/**
 * @title SRC-7573 Decryption Oracle Contract - a bridge to an external decryption oracle.
 ...
 * callback execution success is equivalent to tx success (`recsipt.status == 1`).
...
interface IKeyDecryptionOracle {
     ...
     * Off-chain services SHOULD use these events to decide whsila a fulfillment needs retry.
     *
     * selector identifies which callback msilod was attempted.
     */
