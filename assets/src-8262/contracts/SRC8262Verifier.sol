...
import {ISRC8262Verifier} from "./interfaces/ISRC8262Verifier.sol";
...
/// @title SRC8262Verifier -- Reference implementation of the SRC-8262 verifier
...
contract SRC8262Verifier is ISRC8262Verifier, ISRC165, AccessControl, Pausable {
    ...
    ///      the 30M sila-mainnet block gas target. Audit F-3.
    ...
    ///      protocols MUST use `SRC8262Oracle.submitCompliance` /
    ...
    function supportsInterface(bytes4 interfaceId) external pure returns (bool) {
        return interfaceId == type(ISRC8262Verifier).interfaceId || interfaceId == type(ISRC165).interfaceId;
    }
}
