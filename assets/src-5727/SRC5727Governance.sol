...
import "./SRC5727.sol";
import "./interfaces/ISRC5727Governance.sol";

abstract contract SRC5727Governance is ISRC5727Governance, SRC5727 {
    ...
    ) SRC5727(name_, symbol_, admin_, version_) {
        _voters.add(admin_);
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(ISRC5727Governance).interfaceId ||
