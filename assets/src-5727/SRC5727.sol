...
import "../SRC3525/SRC3525.sol";
import "../SRC5192/interfaces/ISRC5192.sol";
import "./interfaces/ISRC5727Metadata.sol";
import "./interfaces/ISRC5727Enumerable.sol";

contract SRC5727 is SIP712, Ownable, SRC3525, ISRC5727Metadata {
    ...
    ) SRC3525(name_, symbol_, 18) SIP712(name_, version_) Ownable() {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(ISRC165, SRC3525) returns (bool) {
        return
            interfaceId == type(ISRC5727).interfaceId ||
            interfaceId == type(ISRC5727Metadata).interfaceId ||
