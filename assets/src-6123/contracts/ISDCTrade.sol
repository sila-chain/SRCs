...
/**
 * @title SRC6123 Smart Derivative Contract - Trade Events and Trade Functions.
...
interface ISDCTrade {
     ...
     * @param tradeData a description of the trade specification e.g. in xml format, suggested structure - see assets/sip-6123/doc/sample-tradedata-filestructure.xml
