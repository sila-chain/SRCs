...
contract FxAtomicSwapFactory {
    ...
    SRC20AtomicSwapSettlementRouter public immutable settlementRouter;
     ...
     */
    constructor() {
        settlementRouter = new SRC20AtomicSwapSettlementRouter(address(this));
    }
     ...
     * @param baseToken SRC-20 token represented by the signed position.
     * @param quoteToken SRC-20 token represented by the signed payment amount.
