...
contract FxAtomicSwap is ISDCTrade, IXMLRepresentableState {
    ...
    function stateXmlTemplate() external pure override returns (string memory) {
        return string.concat(
            ...
            "<Lifecycle>",
            "<TradeId>1</TradeId>",
            "<Phase svmstate:call='phase()(uint8)' svmstate:format='decimal'/>",
            "<Inceptor svmstate:call='inceptor()(address)' svmstate:format='address'/>",
            "</Lifecycle>",
            "<Parties>",
            "<Party role='A' svmstate:call='partyA()(address)' svmstate:format='address'/>",
            "<Party role='B' svmstate:call='partyB()(address)' svmstate:format='address'/>",
            "</Parties>",
            "<Tokens>",
            "<Token role='base' svmstate:call='baseToken()(address)' svmstate:format='address'/>",
            "<Token role='quote' svmstate:call='quoteToken()(address)' svmstate:format='address'/>",
            "</Tokens>",
            "<SettlementRouter svmstate:call='settlementRouter()(address)' svmstate:format='address'/>",
            "<Terms view='inceptor'>",
            "<Position token='base' unit='smallest-token-unit' ",
            "svmstate:call='position()(int256)' svmstate:format='decimal'/>",
            "<PaymentAmount token='quote' unit='smallest-token-unit' ",
            "svmstate:call='paymentAmount()(int256)' svmstate:format='decimal'/>",
            "<TradeData svmstate:call='tradeData()(string)' svmstate:format='string'/>",
            "<InitialSettlementData svmstate:call='initialSettlementData()(string)' ",
