...
import "./SRC20Settlement.sol";



/**
 * @title Reference Implementation of SRC6123 - Abstract Class for OTC Derivatives
 ...
 * - A Settlement Token (based on SRC20) is used for settlement able to process batched transfers
 * - upon termination all remaining 'locked' amounts will be transferred back to the counterparties
*/

abstract contract SDCSingleTrade is ISDCTrade {
    /*
     * Trade States
     */
    enum TradeState {
    ...
    */
     ...
     * - balance for SDC
     */
    SRC20Settlement internal settlementToken;
    ...
    constructor(
        ...
        party1 = _party1;
        party2 = _party2;
        settlementToken = SRC20Settlement(_settlementToken);
