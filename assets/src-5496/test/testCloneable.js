...
const SRC5496Demo = artifacts.require("SRC5496CloneableDemo");

contract("SRC5496Cloneable", async accounts => {
    ...
    before(async function() {
        const instance = await SRC5496Demo.deployed("SRC5496CDemo", "EPCD");
    ...
    it("NFT should support interface ISRC5496", async () => {
        const interfaceIds = {
            ISRC165: "0x01ffc9a7",
            ISRC721: "0x80ac58cd",
            ISRC5496: "0x076e1bbb",
