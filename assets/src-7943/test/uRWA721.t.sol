...
import {ISRC7943NonFungible} from "../contracts/interfaces/ISRC7943.sol";
import {MockSRC721Receiver} from "../contracts/mocks/MockSRC721Receiver.sol";
...
import {ISRC721Errors} from "@openzeppelin/contracts/interfaces/draft-ISRC6093.sol";
import {IAccessControlEnumerable} from "@openzeppelin/contracts/access/extensions/IAccessControlEnumerable.sol";

contract uRWA721Test is Test {
    uRWA721 public token;
    MockSRC721Receiver public receiverContract;
    ...
    function setUp() public {
        ...
        receiverContract = new MockSRC721Receiver();
        vm.startPrank(admin);
    ...
    function test_Mint_Success() public {
        ...
        emit ISRC721.Transfer(address(0), user2, TOKEN_ID_2);
    ...
    function test_Revert_Mint_ToCannotReceive() public {
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943NonFungible.SRC7943CannotReceive.selector, nonWhitelistedUser));
        token.safeMint(nonWhitelistedUser, TOKEN_ID_2);
    }

    function test_Revert_Mint_ExistingTokenId() public {
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721InvalidSender.selector, address(0)));
        token.safeMint(user2, TOKEN_ID_1);
    }

    function test_Revert_Mint_ToZeroAddress() public {
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721InvalidReceiver.selector, address(0)));
    ...
    function test_Revert_Mint_ToContractThatRejects() public {
        ...
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721InvalidReceiver.selector, address(receiverContract)));
        token.safeMint(address(receiverContract), TOKEN_ID_2);
    }
    ...
    function test_Burn_Success_ByOwnerBurner() public {
        ...
        vm.prank(user1);
        vm.expectEmit(true, true, true, true);
        emit ISRC721.Transfer(user1, address(0), TOKEN_ID_1);
        token.burn(TOKEN_ID_1);

        assertEq(token.balanceOf(user1), 0);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721NonexistentToken.selector, TOKEN_ID_1));
    ...
    function test_Burn_Success_UnfreezesFrozenToken() public {
        ...
        vm.prank(user1);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943NonFungible.Frozen(user1, TOKEN_ID_1, false);
        vm.expectEmit(true, true, true, true);
        emit ISRC721.Transfer(user1, address(0), TOKEN_ID_1);
        token.burn(TOKEN_ID_1);
    ...
    function test_Revert_Burn_BurnerNotOwnerOrApproved() public {
        vm.prank(burner);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721InsufficientApproval.selector, burner, TOKEN_ID_1));
        token.burn(TOKEN_ID_1);
    }

    function test_Revert_Burn_NonExistentToken() public {
        vm.prank(burner);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721NonexistentToken.selector, NON_EXISTENT_TOKEN_ID));
    ...
    function test_Revert_Burn_CannotSend() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943NonFungible.SRC7943CannotSend.selector, user1));
        token.burn(TOKEN_ID_1);
    }
    ...
    function test_GetFrozenTokens_NonOwner() public {
        ...
        vm.prank(user2);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943NonFungible.SRC7943InsufficientUnfrozenBalance.selector, user2, TOKEN_ID_1));
    ...
    function test_Transfer_Success_WhitelistedToWhitelisted() public {
        vm.prank(user1);
        vm.expectEmit(true, true, true, true);
        emit ISRC721.Transfer(user1, user2, TOKEN_ID_1);
        token.transferFrom(user1, user2, TOKEN_ID_1);
        assertEq(token.ownerOf(TOKEN_ID_1), user2);
    }
    ...
    function test_Revert_Transfer_NotOwnerOrApproved() public {
        vm.prank(user2);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721InsufficientApproval.selector, user2, TOKEN_ID_1));
        token.transferFrom(user1, user2, TOKEN_ID_1);
    }
    ...
    function test_Revert_Transfer_WhenFrozen() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943NonFungible.SRC7943InsufficientUnfrozenBalance.selector, user1, TOKEN_ID_1));
        token.transferFrom(user1, user2, TOKEN_ID_1);
    }
    ...
    function test_ForcedTransfer_Success_WhitelistedToWhitelisted() public {
        ...
        emit ISRC721.Transfer(user1, user2, TOKEN_ID_1);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943NonFungible.ForcedTransfer(user1, user2, TOKEN_ID_1);
    ...
    function test_Revert_ForcedTransfer_FromIncorrectOwner() public {
        vm.prank(forceTransferrer);
        vm.expectRevert(abi.encodeWithSelector(ISRC721Errors.SRC721IncorrectOwner.selector, user2, TOKEN_ID_1, user1));
    ...
    function test_SetFrozenTokens_Success_FreezeToken() public {
        vm.prank(freezer);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943NonFungible.Frozen(user1, TOKEN_ID_1, true);
        token.setFrozenTokens(user1, TOKEN_ID_1, true);
        assertTrue(token.getFrozenTokens(user1, TOKEN_ID_1));
    }
    ...
    function test_Interface_SupportsISRC7943() public view {
        assertTrue(token.supportsInterface(type(ISRC7943NonFungible).interfaceId));
    }

    function test_Interface_SupportsISRC721() public view {
        assertTrue(token.supportsInterface(type(ISRC721).interfaceId));
    }
    ...
    function test_EdgeCase_ForceTransferToContract() public {
        vm.prank(forceTransferrer);
        vm.expectEmit(true, true, true, true);
        emit ISRC721.Transfer(user1, address(receiverContract), TOKEN_ID_1);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943NonFungible.ForcedTransfer(user1, address(receiverContract), TOKEN_ID_1);
