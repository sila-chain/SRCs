...
import {ISRC7943MultiToken} from "../contracts/interfaces/ISRC7943.sol";
import {MockSRC1155Receiver} from "../contracts/mocks/MockSRC1155Receiver.sol";
...
contract uRWA1155Test is Test {
    ...
    MockSRC1155Receiver public receiverContract;
    ...
    function setUp() public {
        ...
        receiverContract = new MockSRC1155Receiver();
        vm.startPrank(admin);
    ...
    function test_Mint_Success() public {
        ...
        emit ISRC1155.TransferSingle(minter, address(0), user2, TOKEN_ID_2, MINT_AMOUNT);
    ...
    function test_Revert_Mint_ToCannotReceive() public {
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943MultiToken.SRC7943CannotReceive.selector, nonWhitelistedUser));
        token.mint(nonWhitelistedUser, TOKEN_ID_2, MINT_AMOUNT);
    }

    function test_Revert_Mint_ToZeroAddress() public {
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InvalidReceiver.selector, address(0)));
        vm.prank(minter);
    ...
    function test_Revert_Mint_ToContractThatRejects() public {
        ...
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InvalidReceiver.selector, address(receiverContract)));
        token.mint(address(receiverContract), TOKEN_ID_2, MINT_AMOUNT);
    }
    ...
    function test_MintBatch_Success() public {
        ...
        vm.prank(minter);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferBatch(minter, address(0), user2, ids, amounts);
    ...
    function test_Revert_MintBatch_ArraysLengthMismatch() public {
        ...
        vm.prank(minter);
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InvalidArrayLength.selector, 2, 1));
        token.mintBatch(user2, ids, amounts);
    }
    ...
    function test_Burn_Success() public {
        ...
        vm.prank(user1);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(user1, user1, address(0), TOKEN_ID_1, BURN_AMOUNT);
    ...
    function test_Burn_Success_ReducesFrozenWhenExceedsUnfrozen() public {
        ...
        vm.prank(user1);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.Frozen(user1, TOKEN_ID_1, expectedNewFrozenAmount);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(user1, user1, address(0), TOKEN_ID_1, burnAmount);
    ...
    function test_Revert_Burn_InsufficientBalance() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InsufficientBalance.selector, user1, MINT_AMOUNT, burnAmount, TOKEN_ID_1));
        token.burn(TOKEN_ID_1, burnAmount);
    }
    ...
    function test_Revert_Burn_CannotSend() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943MultiToken.SRC7943CannotSend.selector, user1));
        token.burn(TOKEN_ID_1, BURN_AMOUNT);
    }
    ...
    function test_BurnBatch_Success() public {
        ...
        vm.prank(user1);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferBatch(user1, user1, address(0), ids, amounts);
    ...
    function test_BurnBatch_Success_ReducesFrozenWhenExceedsUnfrozen() public {
        ...
        emit ISRC7943MultiToken.Frozen(user1, TOKEN_ID_1, expectedNewFrozenAmount);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.Frozen(user1, TOKEN_ID_2, expectedNewFrozenAmount);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferBatch(user1, user1, address(0), ids, amounts);
        token.burnBatch(ids, amounts);
    ...
    function test_Revert_BurnBatch_InsufficientBalance() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InsufficientBalance.selector, user1, MINT_AMOUNT, MINT_AMOUNT + 1, TOKEN_ID_2));
        token.burnBatch(ids, amounts);
    }
    ...
    function test_Freeze_MoreThanBalance_Success() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943MultiToken.SRC7943InsufficientUnfrozenBalance.selector, user1, TOKEN_ID_1, 1, 0));
    ...
    function test_Revert_SelfTransfer_WhenFrozen() public {
        ...
        uint256 transferAmount = balance - freezeAmount + 1;
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943MultiToken.SRC7943InsufficientUnfrozenBalance.selector, user1, TOKEN_ID_1, transferAmount, balance - freezeAmount));
    ...
    function test_Transfer_Success_WhitelistedToWhitelisted() public {
        ...
        vm.prank(user1);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(user1, user1, user2, TOKEN_ID_1, TRANSFER_AMOUNT);
    ...
    function test_Revert_Transfer_NotApproved() public {
        vm.prank(user2);
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155MissingApprovalForAll.selector, user2, user1));
        token.safeTransferFrom(user1, user2, TOKEN_ID_1, TRANSFER_AMOUNT, "");
    }
    ...
    function test_Revert_Transfer_InsufficientBalance() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InsufficientBalance.selector, user1, MINT_AMOUNT, transferAmount, TOKEN_ID_1));
    ...
    function test_Revert_Transfer_InsufficientUnfrozenBalance() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943MultiToken.SRC7943InsufficientUnfrozenBalance.selector, user1, TOKEN_ID_1, transferAmount, available));
        token.safeTransferFrom(user1, user2, TOKEN_ID_1, transferAmount, "");
    }
    ...
    function test_Revert_Transfer_WhenFrozen() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ISRC7943MultiToken.SRC7943InsufficientUnfrozenBalance.selector, user1, TOKEN_ID_1, availableToTransfer + 1, availableToTransfer));
        vm.prank(user1);
    ...
    function test_ForcedTransfer_Success_WhitelistedToWhitelisted() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(forceTransferrer, user1, user2, TOKEN_ID_1, FORCE_TRANSFER_AMOUNT);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.ForcedTransfer(user1, user2, TOKEN_ID_1, FORCE_TRANSFER_AMOUNT);
    ...
    function test_ForcedTransfer_Success_ReducesFrozenWhenExceedsUnfrozen() public {
        ...
        emit ISRC7943MultiToken.Frozen(user1, TOKEN_ID_1, expectedNewFrozenAmount);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(forceTransferrer, user1, user2, TOKEN_ID_1, forceTransferAmount);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.ForcedTransfer(user1, user2, TOKEN_ID_1, forceTransferAmount);
    ...
    function test_ForcedTransfer_Success_AllTokensFrozenThenForceTransferAll() public {
        ...
        vm.prank(forceTransferrer);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.Frozen(user1, TOKEN_ID_1, 0);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(forceTransferrer, user1, user2, TOKEN_ID_1, MINT_AMOUNT);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.ForcedTransfer(user1, user2, TOKEN_ID_1, MINT_AMOUNT);
    ...
    function test_Revert_ForcedTransfer_InsufficientBalance() public {
        ...
        vm.prank(forceTransferrer);
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InsufficientBalance.selector, user1, MINT_AMOUNT, forceAmount, TOKEN_ID_1));
    ...
    function test_Revert_ForcedTransfer_FromZeroAddress() public {
        vm.prank(forceTransferrer);
        vm.expectRevert(abi.encodeWithSelector(ISRC1155Errors.SRC1155InvalidSender.selector, address(0)));
    ...
    function test_ForcedTransfer_ToContractReceiver() public {
        vm.prank(forceTransferrer);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(forceTransferrer, user1, address(receiverContract), TOKEN_ID_1, FORCE_TRANSFER_AMOUNT);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.ForcedTransfer(user1, address(receiverContract), TOKEN_ID_1, FORCE_TRANSFER_AMOUNT);
    ...
    function test_SafeBatchTransfer_Success_WhitelistedToWhitelisted() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferBatch(user1, user1, user2, ids, amounts);
    ...
    function test_Revert_SafeBatchTransfer_InsufficientUnfrozenBalance() public {
        ...
        vm.prank(user1);
        vm.expectRevert(abi.encodeWithSelector(ISRC7943MultiToken.SRC7943InsufficientUnfrozenBalance.selector, user1, TOKEN_ID_1, amounts[0], MINT_AMOUNT - FREEZE_AMOUNT));
        token.safeBatchTransferFrom(user1, user2, ids, amounts, "");
    }
    ...
    function test_SetFrozenTokens_Success_EmitsCorrectEvents() public {
        ...
        vm.prank(freezer);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.Frozen(user1, TOKEN_ID_1, newFrozenAmount);
        token.setFrozenTokens(user1, TOKEN_ID_1, newFrozenAmount);

        uint256 updatedFrozenAmount = FREEZE_AMOUNT * 2;
        vm.prank(freezer);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.Frozen(user1, TOKEN_ID_1, updatedFrozenAmount);
    ...
    function test_Interface_SupportsISRC7943() public view {
        assertTrue(token.supportsInterface(type(ISRC7943MultiToken).interfaceId));
    }

    function test_Interface_SupportsISRC1155() public view {
        assertTrue(token.supportsInterface(type(ISRC1155).interfaceId));
    }

    function test_Interface_SupportsISRC165() public view {
        assertTrue(token.supportsInterface(type(ISRC165).interfaceId));
    }
    ...
    function test_EdgeCase_ForceTransferExactBalance() public {
        ...
        vm.prank(forceTransferrer);
        vm.expectEmit(true, true, true, true);
        emit ISRC1155.TransferSingle(forceTransferrer, user1, user2, TOKEN_ID_1, userBalance);
        vm.expectEmit(true, true, true, true);
        emit ISRC7943MultiToken.ForcedTransfer(user1, user2, TOKEN_ID_1, userBalance);
    ...
    function test_MockReceiver_SupportsInterface() public view {
        assertTrue(receiverContract.supportsInterface(type(ISRC1155Receiver).interfaceId));
        assertTrue(receiverContract.supportsInterface(type(ISRC165).interfaceId));
