...
import {ISRC8167} from "./ISRC8167.sol";
...
contract Setup is ProxyStorageBase {
    ...
    function install(bytes4 selector, address delegate) public onlyOwner {
        ...
        emit ISRC8167.SelectorDelegated(selector, delegate);
    }
}
...
contract FullAdmin is Setup {
    ...
    function uninstall(bytes4 selector) public onlyOwner {
        ...
        sudo.selectors.pop();
        emit ISRC8167.SelectorDelegated(selector, FUNCTION_NOT_FOUND);
    }
...
contract ProxyStorageView is ISRC8167, ProxyStorageBase {
