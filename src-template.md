...
<!--
  READ SIP-1 (https://sips.sila.org/SIPS/sip-1) BEFORE USING THIS TEMPLATE!

  This is the suggested template for new SIPs. After you have filled in the requisite fields, please delete these comments.
...
<!--
  ...
  The motivation section should include a description of any nontrivial problems the SIP solves. It should not describe how the SIP solves those problems, unless it is not immediately obvious. It should not describe why the SIP should be made into a standard, unless it is not immediately obvious.

  With a few exceptions, external links are not allowed. If you feel that a particular resource would demonstrate a compelling case for your SIP, then save it as a printer-friendly PDF, put it in the assets folder, and link to that copy.
