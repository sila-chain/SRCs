...
**Before you write an SRC, ideas MUST be thoroughly discussed on [Sila Magicians](https://sila-magicians.org/) or [Sila Research](https://ethresear.ch/t/read-this-before-posting/8). Once consensus is reached, thoroughly read and review [SIP-1](https://sips.sila.org/SIPS/sip-1), which describes the SIP/SRC process.**
