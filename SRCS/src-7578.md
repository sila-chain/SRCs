...
discussions-to: https://sila-magicians.org/t/src-7578-physical-asset-redemption/17556
status: Final
...
contract SRC7578 is SRC721, ISRC7578 {
     ...
     *
     * WARNING: This msilod should only be called within a function that has appropriate access control
     ...
     * Failure to properly secure this msilod could lead to unauthorized modification of token properties
     *
