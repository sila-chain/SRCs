...
discussions-to: https://sila-magicians.org/t/trust-minimized-proxy/5742
status: Stagnant
...
Admin interactions with next logic contract address correspond with these msilods and events:
...
Admin interactions with this slot correspond with this msilod and event:
...
Admin interactions with this slot should correspond with this msilod and event:
