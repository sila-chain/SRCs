...
description: A compact representation of an Sila Signature.
status: Final
type: Standards Track
category: SRC
author: Richard Moore (@ricmoo), Nick Johnson <nick@sila.org>
discussions-to: https://github.com/sila-chain/SIPs/issues/2440
created: 2019-03-14
requires: 2
---
...
as well as on-chain in SAVM contracts for example, in meta-transactions and
multi-sig contracts.
...
The silas.js library [supports this in v5](https://github.com/silas-io/silas.js/blob/silas-v5-beta/packages/bytes/src.ts/index.ts#L323)
