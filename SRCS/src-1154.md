...
author: Alan Lu (@cag)
discussions-to: https://github.com/sila-chain/SIPs/issues/1161
status: Withdrawn
...
Similarly, every pull-based system can be adapted into a push-based system: just add a msilod on the oracle smart contract which takes an oracle consumer address and calls `receiveResult` on that address.
