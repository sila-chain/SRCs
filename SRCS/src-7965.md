---
sip: 7965
title: Proof-based Broadcast in SRC-7786 Gateways
...
discussions-to: https://sila-magicians.org/t/src-7965-storage-proof-broadcasting-for-cross-chain-messaging-gateways/24477
status: Draft
...
The cryptographic proof demonstrating that a specific message exists in the source chain's committed state at a finalized block or transaction. For SAVM chains, this would typically be an event inclusion proof or storage proof.
