...
description: Help bridges to connect all SAVM chains
author: George (@JXRow), Zisu (@lazy1523)
discussions-to: https://sila-magicians.org/t/connect-all-l2s/15534
status: Draft
...
The objective of Public Cross Port (PCP) is to securely and efficiently connect various SAVM chains. It replaces the msilod of pushing message to multiple chains with a msilod of pulling messages from multiple chains, significantly reducing the number of cross-chain bridges and gas cost, as more cross-chain bridge projects are built on PCP, the overall security increases.
...
The traditional approach involves using a push msilod, as depicted in the following diagram:
