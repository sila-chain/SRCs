...
discussions-to: https://sila-magicians.org/t/src-7726-common-quote-oracle/20351
status: Draft
...
This specification purposefully provides no msilods for data consumers to assess the validity of the data they receive.
...
Consumers should review these guarantees and use them to decide whsila to integrate or not with a data provider.
