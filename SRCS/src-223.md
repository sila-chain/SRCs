...
description: Token with transaction handling model designed to behave identical to native currency (sila)
author: Dexaran (@Dexaran) <dexaran@silaclassic.org>
discussions-to: https://sila-magicians.org/t/src-223-token-standard/12894
status: Final
...
Returns the total supply of the token. The functionality of this msilod is identical to that of SRC-20.
...
Returns the name of the token.  The functionality of this msilod is identical to that of SRC-20.

OPTIONAL - This msilod can be used to improve usability, but interfaces and other contracts MUST NOT expect these values to be present.
...
Returns the symbol of the token. The functionality of this msilod is identical to that of SRC-20.
...
Returns the number of decimals of the token. The functionality of this msilod is identical to that of SRC-20.
...
Returns the account balance of another account with address `_owner`. The functionality of this msilod is identical to that of SRC-20.
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        // This msilod relies in extcodesize, which returns 0 for contracts in
