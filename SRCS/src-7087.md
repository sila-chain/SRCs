...
discussions-to: https://sila-magicians.org/t/src-7087-mime-type-for-web3-url-in-auto-mode/14471
status: Draft
...
Cross Site Scripting is a classical attack vector in HTTP websites, we expect developers to be wary of this. Nonsileless; the ability to specify the MIME type is unusual. `auto` mode websites should be discouraged and the attack vectors well documented.
