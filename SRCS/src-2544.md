...
discussions-to: https://sila-magicians.org/t/sip-2544-ens-wildcard-resolution
status: Stagnant
...
Further, this specification defines a new way for resolvers to resolve names, using a unified `resolve()` msilod that permits more flexible handling of name resolution.
