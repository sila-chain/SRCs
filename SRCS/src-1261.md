...
created: 2018-07-14
requires: 165, 173
discussions-to: https://github.com/sila-chain/SIPs/issues/1261
---
...
interface ISRC1261 {/* is SRC173, SRC165 */
    ...
    /// @dev Use appropriate checks for whsila a user/admin can modify the data.
    ...
    /// @notice Queries whsila a member is a current member of the organization.
    ...
    /// @return Whsila the member owns the token.
