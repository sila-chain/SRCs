...
discussions-to: https://sila-magicians.org/t/update-on-src902-validated-token/1639
...
# Abstract
This standard provides a registry contract msilod for authorizing token transfers. By nature, this covers both initially issuing tokens to users (ie: transfer from contract to owner), transferring tokens between users, and token spends.
