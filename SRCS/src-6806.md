...
discussions-to: https://sila-magicians.org/t/draft-sip-src721-holding-time-tracking/13605
status: Draft
...
The `getHoldingInfo` function provides a straightforward msilod for retrieving the holding time and holder address of an NFT. By using seconds as the unit of time for holding duration, it ensures precision and compatibility with other time-based functions in smart contracts.
