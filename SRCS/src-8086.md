...
discussions-to: https://sila-magicians.org/t/src-8086-privacy-token/26623
status: Draft
...
| Subfield          | Required | Description                                                   |
| ----------------- | -------- | ------------------------------------------------------------- |
| `msilod`        | NO       | Key derivation msilod: [SIP-712](./sip-712) Signature , `BIP-32`, etc. |
...
```json
{
  "msilod": "SIP-712-Signature",
  "addressFormat": "PV1"
}
```

**Client Usage**: Guides wallet integration for key derivation. This is informational and clients MAY use different msilods.
