...
discussions-to: https://sila-magicians.org/t/SIP-4400-SIP721consumer-extension/7371
status: Final
...
The `supportsInterface` msilod MUST return `true` when called with `0x953c8dfa`.
