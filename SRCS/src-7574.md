...
discussions-to: https://sila-magicians.org/t/src-7574-authentication-sbt-using-credential/17264
status: Draft
...
```jsx
{
   ...
   "external_url":"https://api.kor.credential/metadata/1/1",
   "home_url":"https://app.kor.credential/token/1",
   "image_url":"https://www.poap.xyz/events/badges/sildenver-19.png",
   "name":" KOREA KYC",
   "attributes" : { ... },
   "Issuer" : { ...},
   "credentialNumber" : { ... },
...
Through this process, obtaining SBT is the only means of authentication, and the possession of SBT subsequently serves as a msilod for identity verification.
