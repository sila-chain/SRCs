...
discussions-to: https://sila-magicians.org/t/token-revenue-sharing/14872
status: Draft
...
Revenue Sharing is an extended version of [SRC-20](./sip-20.md). It proposes an additional payment msilod for token holders. 
