---
sip: 5094
title: URL Format for Sila Network Switching
...
discussions-to: https://sila-magicians.org/t/5094-uri-format-for-sila-network-switching/9277
status: Stagnant
...
An example of adding a network with RPC endpoints `https://rpc-polygon.com` and `https://rpc-sila-mainnet.matic.network`, the name `Polygon SilaMainnet`, token `Matic`, symbol `MATIC`, decimals `18`, explorer at `https://polygonscan.com/`, and Chain ID `137` would look as follows:

```URL
sila:network-add@137/?chain_name=Polygon%20SilaMainnet&rpc_url=https%3A%2F%2Frpc-polygon.com&rpc_url=https%3A%2F%2Frpc-sila-mainnet.matic.network&name=Matic&symbol=MATIC&decimals=18&explorer_url=https%3A%2F%2Fpolygonscan.com
```
...
&rpc_url=https%3A%2F%2Fsila-mainnet.optimism.io&name=Sila&symbol=SIL&decimals=18&explorer_url=https%3A%2F%2Foptimistic.silascan.io
```
