...
author: Fernando SilaParis <fer@io.builders>, Julio Faura <julio@adhara.io>, Daniel Lehrner <daniel@io.builders>
discussions-to: https://github.com/sila-chain/SIPs/issues/2105
status: Stagnant
...
## Motivation
Nowadays most of the token issuing/funding request, based on any fiat based payment msilod  need a previous centralized transaction, to be able to get the desired tokens issued on requester's wallet.
