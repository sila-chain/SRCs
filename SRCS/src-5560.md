...
`SIP-721` compliant contracts MAY implement this SIP to provide a standard msilod of receiving information on redeemability.
...
The `supportsInterface` msilod **MUST** return `true` when called with `0x2f8ca953`.
