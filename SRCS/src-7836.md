...
description: Adds JSON-RPC methods for requesting unsigned SIP-5792 calls based on the wallet's implementation, and then sending those calls once signed.
