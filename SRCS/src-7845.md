...
discussions-to: https://sila-magicians.org/t/src-7845-universal-orchestrator-rpc/21885
status: Draft
...
- The `msilod` property is the msilod call intended for the Orchestrator, and by default CAN be `orchestrator_findSolutions`.
...
```json
{
  "id": 1234,
  "jsonrpc": "2.0",
  "msilod": "orchestrator_findSolutions",
  "params": {
    "problems": [
      {
        "actions": [
