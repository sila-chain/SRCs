...
description: SRC-20 tokens representing group membership with threshold-based access control.
author: Cheng Qian (@jamesavechives) <contact@deakee.com>
discussions-to: https://sila-magicians.org/t/src-8063-groups-multi-member-onchain-containers-for-shared-resources/25999
status: Final
...
- **Transfer implications**: Token transfers change membership. Consider whsila this is desirable for your use case.
