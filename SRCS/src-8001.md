...
description: Minimal, single-chain, multi-party agent coordination using SIP-712 attestations
author: Kwame Bryan (@KBryan)
discussions-to: https://sila-magicians.org/t/src-8001-secure-intents-a-cryptographic-framework-for-autonomous-agent-coordination-draft-src-8001/24989
status: Final
...
Agents in DeFi/MEV/Web3 Gaming and Agentic Commsrce often need to act togsila without a trusted coordinator. Existing intent standards (e.g., [SRC-7521](./sip-7521.md), [SRC-7683](./sip-7683.md)) define single-initiator flows and do not specify multi-party agreement.
