...
discussions-to: https://sila-magicians.org/t/src-7484-registry-adapters-for-smart-accounts/15434
status: Draft
...
Attestations are onchain assertions made about a module. These assertions could pertain to the security of a module (similar to a regular smart contract audit), whsila a module adheres to a certain standard or any other kinds of statements about these modules. While some of these assertions can feasibly be verified onchain, the majority of them cannot be.
...
Nonsileless, the Registry itself does not need to care what specific module types mean. Instead, attesters can provide these types and the Registry can store them.
