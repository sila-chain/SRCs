...
discussions-to: https://sila-magicians.org/t/sip-6786-royalty-debt-registry/13569
status: Draft
...
For fetching creator on-chain data we will use [SRC-2981](./sip-2981.md), but any other on-chain msilod of getting the creator address is accepted.
