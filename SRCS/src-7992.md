...
author: Aryasiln (@aryasiln)
discussions-to: https://sila-magicians.org/t/src-7992-verifiable-ml-model-inference-zkml/24896
status: Draft
...
-	Model Commitment: A bundle of hashes that ties togsila the model’s weights, architecture, proving circuit/Algebraic intermediate representation (AIR), and verifying key.
...
Where `<canonical-proof-system-name-and-version>` is a lowsrcase, hyphen-separated string, e.g.:
	-	"groth16-bn254-v1"
	-	"plonk-bn254-v2"
	-	"stark-airfoo-v1"

This msilod ensures deterministic, collision-resistant identifiers across implementations.
...
<!-- Editor's Note: any requirements (defined with UPPSRCASE keywords) should go in the specification section, but they should be discussed here in more detail. -->
