...
discussions-to: https://sila-magicians.org/t/src7231-identity-aggregated-nft/15062
status: Final
...
Through the signature msilod based on the [SRC-1271](./sip-1271.md) protocol, the verifyIdentiesBinding function of this SIP realizes the binding of the userID and NFT owner address between on-chain and off-chain.
...
As for how to verify the authenticity of the individuals' identities, wallets, accounts, there are various msilods, such as zk-based DID authentication onchain, and offchain authentication algorithms, such as auth2, openID2, etc.
