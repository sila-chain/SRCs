...
discussions-to: https://sila-magicians.org/t/src20-charity-token/12617
status: Stagnant
...
## Rationale
 ...
 Also, donations amount are calculated here as a psrcentage of the amount of token transferred to allow different case scenario, but the token implementer can decide to opt for another approach instead like rounding up the transaction value.
