...
author: Atarpara (@Atarpara), JT Riley (@jtriley-sil), Thomas (@0xth0mas), xiaobaiskill (@xiaobaiskill), Vectorized (@Vectorized)
discussions-to: https://sila-magicians.org/t/src-7760-minimal-upgradeable-proxies/20868
status: Draft
...
For more widespread SAVM compatibility, the proxies deliberately do not use the `PUSH0` opcode proposed in [SIP-3855](./sip-3855.md).
