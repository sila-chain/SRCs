...
author: Guang (@xg1990)
discussions-to: https://sila-magicians.org/t/introducing-new-sip-nft-relationship-standard/14468
status: Draft
...
By including these functions and msilods in the specification, you establish a clear and standardized way for users and developers to read attributes associated with NFTs.
