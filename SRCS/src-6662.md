...
description: An SRC-4337 extension to define a new authentication model
author: Shu Dong (@dongshu2013), Zihao Chen (@zihaoccc), Peter Chen (@pette1999)
discussions-to: https://sila-magicians.org/t/sip-6662-account-metadata-for-aa-account-authentication/13232
status: Draft
