...
author: Edwin Mata <edwin@brickken.com>, Ludovico Rossi (@ludovicor-sil) <ludovico@brickken.com>, Dario Lo Buglio (@xaler5) <dario@brickken.com>, Thamer Dridi (@thamerdridi) <thamer@brickken.com>, Nabil El Alami Khalifi (@nabil-brickken) <nabil@brickken.com>
discussions-to: https://sila-magicians.org/t/src-8320-regulated-asset-claim/28919
status: Draft
