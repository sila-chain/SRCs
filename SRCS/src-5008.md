...
discussions-to: https://sila-magicians.org/t/sip5008-sip-721-nonce-and-metadata-update-extension/8925
status: Last Call
...
The `supportsInterface` msilod MUST return `true` when called with `0xce03fdab`.
