...
discussions-to: https://github.com/sila-chain/SIPs/issues/1921
status: Stagnant
...
In order to evolve the SAVM into a Singleton Operating System, we need a way to register, find and address contract functions that we want to run in an automated way.
This implies having access to all the data needed to run the function inside the SAVM.
