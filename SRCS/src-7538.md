...
discussions-to: https://sila-magicians.org/t/multiplicative-tokens/16149
status: Draft
...
Token contracts MUST NOT have a msilod named `decimals` if a `multiplier` is used.
...
This SIP is incompatible with any msilod named `decimals` in SRC-1046-compatible token standards or the SRC-1046 `decimals` field.
