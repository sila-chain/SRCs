...
discussions-to: https://sila-magicians.org/t/sip-5489-nft-hyperlink-extension/10431
status: Final
...
The `supportInterface` msilod MUST return true when called with `0x8f65987b`.
