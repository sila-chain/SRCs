...
discussions-to: https://sila-magicians.org/t/sip-2494-baby-jubjub-elliptic-curve/3968
status: Stagnant
...
- *Rho msilod* [[Blake-Seroussi-Smart, Section V.1]](https://www.cambridge.org/core/books/elliptic-curves-in-cryptography/16A2B60636EFA7EBCC3D5A5D01F28546): we require the cost for the rho msilod, which takes on average around `0.886*sqrt(l)` additions, to be above `2^100`.
