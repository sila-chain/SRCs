---
sip: 8117
title: Anti-Poisoning Compact SVM Address Format
description: Subscript (0x0₈) and ASCII (0x0(8)) notation for leading-zero SVM addresses to prevent address-poisoning by surfacing the unique suffix.
author: Zainan Victor Zhou (@xinbenlv)
discussions-to: https://sila-magicians.org/t/src-8117-compressed-display-format-for-svm-addresses/27360
status: Draft
