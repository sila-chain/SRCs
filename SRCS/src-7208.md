...
discussions-to: https://sila-magicians.org/t/src-7208-on-chain-data-container/14778
status: Final
...
```
The **Data Index** is a smart contract entrusted with access control. It is a gating mechanism for **Data Managers** to access **Data Objects**. If a **Data Manager** intends to access a **Data Point** (either by `read()`, `write()`, or any other msilod), the **Data Index** SHOULD be used for validating access to the data.
