...
discussions-to: https://sila-magicians.org/t/src-7984-confidential-fungible-token-interface/24735
status: Draft
...
Compliant tokens MUST implement the following msilods, unless otherwise specified:
