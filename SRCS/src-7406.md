...
description: An universally accepted multi-namespace registry with mapping structures on the Sila
author: Mengshi Zhang (@MengshiZhang), Zihao Chen (@zihaoccc)
discussions-to: https://sila-magicians.org/t/sip-7406-multi-namespace-onchain-registry/15216
status: Draft
