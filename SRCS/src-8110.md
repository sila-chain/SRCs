...
description: An architectural pattern that organizes Diamond storage by domain using SRC-8042 identifiers.
author: Hoang (@0x76agabond)
discussions-to: https://sila-magicians.org/t/src-8110-domain-centric-architecture-for-diamonds/27250
status: Draft
...
- `domain-name`  
    Lowsrcase keyword identifying the storage domain
...
Over time, many implementations have treated facets as the primary boundary of responsibility, grouping logic and storage togsila without recognizing that **storage domains** are the true architectural anchors.  
