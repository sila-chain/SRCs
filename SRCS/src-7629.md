...
discussions-to: https://sila-magicians.org/t/src-7629-unified-token/18793
status: Draft
...
The primary compatibility point lies in the discrepancy between [SRC-20](./sip-20.md)'s balanceOf and [SRC-721](./sip-721.md)'s balanceOf functionalities. Developers accustomed to the specific balance query msilods in each standard may face challenges when transitioning to this proposal.
