...
description: ZKmeta is a msilod to discover ZK circuit identifiers, semantic versions, verification keys, public input schemas.
author: cococay (@zwowo1997)
discussions-to: https://sila-magicians.org/t/sip-0000-standardized-zk-metadata-interface/26511
status: Draft
