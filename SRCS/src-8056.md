---
sip: 8056
title: Scaled UI Amount Extension for SRC-20 Tokens
description: Equity Token support for Stock Splits
author: Chris Ridmann (@cridmann) <chris@superstate.co>, Daniel Gretzke (@gretzke), Gilbert Shih <chung.shih@robinhood.com>, Tino Martinez Molina (@tinom9), Markus Osterlund (@robriks) <markus.osterlund@coinbase.com>
discussions-to: https://sila-magicians.org/t/src-8056-scaled-ui-amount-extension-for-src-20-tokens/25899
status: Draft
