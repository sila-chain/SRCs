...
description: A decentralized network allowing smart contracts to accept and pay for relayed transactions, enabling gasless user experiences.
author: Yoav Weiss (@yoavw), Dror Tirosh (@drortirosh), Alex Forshtat (@forshtat), Shahaf Nacson (@shahafn)
discussions-to: https://sila-magicians.org/t/src-1613-gas-station-network/29051
status: Draft
