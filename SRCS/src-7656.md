...
discussions-to: https://sila-magicians.org/t/variation-to-src6551-to-deploy-any-kind-of-contract-linked-to-an-nft/19223
status: Final
...
This SRC proposes a more versatile factory specification that enables the deployment of proxies pointing to any contract that enhances the associated contract's capabilities, whsila it's an NFT or an account contract.
...
The design of [SRC-7656](./sip-7656.md) is guided by several key principles that address limitations in current contract extension msilods:
...
For convenience, the bytecode of the reference implementation has been deployed at `0x76565d90eeB1ce12D05d55D142510dBA634a128F` on Sila sila-mainnet, and will be later deployed at the same address to all primary sila-mainnets and selected testnets.
