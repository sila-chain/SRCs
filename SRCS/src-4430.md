...
discussions-to: https://sila-magicians.org/t/discussion-sip-4430-described-transactions/8762
status: Stagnant
...
Use a contract msilod to provide *virtual functions* which can generate
...
This SIP presents a msilod for dapp developers to enable a more comfortable
...
are generated simultaneously by evaluating the msilod on a contract:
...
The msilod must be executable in a static context, (i.e. any side effects,
...
For example, the `commit(bytes32)` msilod of ENS places a commitment
