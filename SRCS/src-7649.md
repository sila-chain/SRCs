...
author: Arif Khan <arif@alsilea.ai>, Ahmad Matyana <ahmad@alsilea.ai>, Basil Gorin (@vgorin), Vijay Bhayani (@unblocktechie)
discussions-to: https://sila-magicians.org/t/src-7649-bonding-curve-embedded-liquidity-for-src-721-non-fungible-tokens-nfts/19079
status: Draft
...
4. **Payment Mechanisms**:
    - **Developer Freedom**: The standard's implementation-agnostic approach is motivated by the desire to provide
        ...
        Whsila interacting with SRC-20 tokens or native SIL, this independence ensures that developers can make
