...
discussions-to: https://github.com/sila-chain/SIPs/issues/1503
status: Stagnant
...
- **Administrator Data**: owner’s address, Handler contract’s address and a boolean indicating whsila the contract is initialized or not;
