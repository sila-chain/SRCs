...
discussions-to: https://sila-magicians.org/t/sip-4955-non-fungible-token-metadata-namespaces-extension/8746
status: Final
...
The same security considerations as with [SIP-721](./sip-721.md) apply related to using http gateways or IPFS for the tokenURI msilod.
