...
discussions-to: https://sila-magicians.org/t/src-7913-key-verifiers/23262
status: Final
...
Consistency with existing systems (ecrecover and SRC-1271) requires the message to be `bytes32` hash. These are usually produced following [SRC-191](./sip-191.md) or [SRC-712](./sip-712.md). Cryptographic systems that use different hashing msilods SHOULD see this hash as a message, and possibly rehash it following the relevant standards.
