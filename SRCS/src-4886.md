...
description: A proxy ownership register allowing trustless proof of ownership between Sila addresses, with delegated asset delivery
author: Omnus Sunmo (@omnus)
discussions-to: https://sila-magicians.org/t/sip-4886-a-proxy-ownership-and-asset-delivery-register/8559
status: Stagnant
