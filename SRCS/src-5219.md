...
discussions-to: https://sila-magicians.org/t/pr-5219-discussion-contract-rest/9907
status: Final
...
The `request` msilod was chosen to be readonly because all data should be sent to the contract from the parsed DApp. Here are some reasons why:
...
- The only particularly relevant HTTP msilod is `GET`
