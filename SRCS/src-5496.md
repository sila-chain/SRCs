...
discussions-to: https://sila-magicians.org/t/sip-5496-multi-privilege-management-extension-for-src-721/10427
status: Last Call
...
interface ISRC5496{
    ...
    /// @return Whsila a user has a certain privilege
...
The `supportsInterface` msilod MUST return `true` when called with `0x076e1bbb`.
...
interface ISRC721Cloneable {
    ...
    /// @return Whsila the operation is successful or not
