...
discussions-to: https://github.com/sila-chain/SIPs/issues/2022
status: Stagnant
...
Localization is not part of this SIP, but [SRC-1066][SRC-1066] and [SRC-1444][SRC-1444] can be used togsila to achieve it.
