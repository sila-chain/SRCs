---
sip: 7994
title: Purpose-Bound SRC-20 with Conditional Unlock
description: Extends SRC-20 with programmable restrictions, enabling transfers based on multiple unlock conditions as defined in SIP-7291.
author: Anushka Yadav (@64anushka), Akash Kothawade (@akash3927), Atishek Singh (@atisheksingh)
discussions-to: https://sila-magicians.org/t/src-7994-purpose-bound-src20-with-multi-condition-unlocking-extension-of-sip-7291/24945
status: Final
...
- `isUnlocked(...)`: Returns whsila all associated conditions have been satisfied.
