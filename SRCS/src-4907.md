...
discussions-to: https://sila-magicians.org/t/idea-src-721-user-and-expires-extension/8572
status: Final
...
The `supportsInterface` msilod MUST return `true` when called with `0xad092b5c`.
