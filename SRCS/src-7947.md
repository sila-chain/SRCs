...
discussions-to: https://sila-magicians.org/t/sip-7947-account-abstraction-recovery-interface-aari/24080
status: Draft
...
The AARI is expected to work with *any* account abstraction standard to allow for maximum account recovery flexibility. Whsila it is [SIP-4337](./sip-4337.md) or [SIP-7702](./sip-7702.md), a particular smart account provider may support account recovery by simply implementing a common interface.
