...
description: A msilod to construct multicalls with prepended verifiable off-chain data
author: Noah Litvin (@noahlitvin), db (@dbeal-sil)
discussions-to: https://sila-magicians.org/t/src-7412-on-demand-off-chain-data-retrieval/15346
status: Draft
