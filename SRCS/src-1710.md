...
discussions-to: https://sila-magicians.org/t/standarize-url-format-for-web3-browsers/2422
status: Stagnant
...
`dapp:1@peepsil.com/brunobar79?utm_source=github`

which will open the web3 browser, select `sila-mainnet` (chain_id = 1) and then navigate to:

`https://peepsil.com/brunobar79?utm_source=github`
