...
author: Alexi (@alexi)
discussions-to: https://sila-magicians.org/t/sip-5050-nft-interaction-standard/9922
status: Stagnant
...
Action handling within each contract can be arbitrarily complex, and there is no way to eliminate the possibility that certain contract interactions will run out of gas. However, developers SHOULD make every effort to minimize gas usage in their action handler msilods, and avoid the use of for-loops.
