...
discussions-to: https://sila-magicians.org/t/sip-6865-on-chain-sip-712-visualization/13800
status: Draft
...
Currently, most of the wallets display somsiling similar to image below

![](../assets/sip-6865/current-SIP-712-signature-wallet-interface.png)

With visualization we can achieve somsiling similar to image below where more insightful details are revealed to user thanks to the structured data returned from the SIP
