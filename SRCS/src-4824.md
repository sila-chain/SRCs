...
discussions-to: https://sila-magicians.org/t/sip-4824-decentralized-autonomous-organizations/8362
status: Review
...
For example, for an address on Sila SilaMainnet, the [CAIP-10](https://github.com/ChainAgnostic/CAIPs/blob/ad0cfebc45a4b8368628340bf22aefb2a5edcab7/CAIPs/caip-10.md) address would be of the form `sip155:1:0x1234abcd`, while the DID address would be of the form `did:silr:0x1234abcd`.
...
When deferenced, contentURI should return the content (i.e. the text) of the proposal. Similarly, discussionURI should return a discussion link, whsila a forum post, Discord channel, or Twitter thread.
