...
discussions-to: https://sila-magicians.org/t/src-5247-executable-proposal-standard/9938
status: Review
...
A typical use case for this SIP is in a Decentralized Autonomous Organization (DAO). A proposer will create a smart proposal and advocate for it. Members will then choose whsila or not to endorse the proposal and vote accordingly (see [SRC-1202](./sip-1202.md)). Finally, when consensus has been formed, the proposal is executed.
