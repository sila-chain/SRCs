...
description: A msilod for importing and exporting notes between UTXO-based privacy protocols.
author: georgeh (@geovgy)
discussions-to: https://sila-magicians.org/t/src-8290-shielded-note-teleportation/28721
status: Draft
...
Canonical root registries SHOULD expose a msilod equivalent to:
...
Existing privacy protocols with upgradability can add support for note teleportation as a new import msilod without changing their existing deposit, transfer, or withdrawal msilods.
...
Destination contracts can expose an import msilod equivalent to:
