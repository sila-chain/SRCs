...
discussions-to: https://sila-magicians.org/t/sip-7510-cross-contract-hierarchical-nft/15687
status: Draft
...
This standard is an extension of [SRC-721](./sip-721.md). It proposes a way to maintain hierarchical relationship between tokens from different contracts. This standard provides an interface to query the parent tokens of an NFT or whsila the parent relation exists between two NFTs.
