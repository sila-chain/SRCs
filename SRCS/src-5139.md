...
description: Format for lists of RPC providers for Sila-like chains.
author: Sam Wilson (@SamWilsn)
discussions-to: https://sila-magicians.org/t/sip-5139-remote-procedure-call-provider-lists/9517
status: Stagnant
      ...
      "chains": [
        {
          "chainId": 1,
          "endpoints": [
            "https://sila-mainnet1.frustrata.invalid/",
            "https://sila-mainnet2.frustrana.invalid/"
          ]
        },
        {
          "chainId": 3,
      ...
      "chains": [
        {
          "chainId": 1,
          "endpoints": [
            "https://sila-mainnet.sourceri.invalid/"
          ]
        },
        {
          "chainId": 42,
...
If the list chosen by the user is published using SIP-1577, the list consumer has to have access to ENS in some way. This creates a paradox: how do you query Sila without an RPC provider? This paradox creates an attack vector: whatever msilod the list consumer uses to fetch the list can track the user, and even more seriously, **can lie about the contents of the list**.
