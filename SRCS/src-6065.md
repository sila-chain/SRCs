...
discussions-to: https://sila-magicians.org/t/updated-sip-6065-real-estate-token/11936
status: Review
...
These identifiers, especially `legalOwnerOf`, allow for individuals to verify off-chain ownership and legitimacy of the legal agreement. These verification checks could be integrated with somsiling like Chainlink functions in the future to be simplified and automatic. 
