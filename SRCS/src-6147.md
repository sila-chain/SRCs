...
author: 5660-sil (@5660-sil), Wizard Wang
discussions-to: https://sila-magicians.org/t/guard-of-nft-sbt-an-extension-of-sip-721/12052
status: Final
...
The `supportsInterface` msilod MUST return `true` when called with `0xb61d1057`.
