...
discussions-to: https://github.com/sila-chain/SIPs/issues/1495
status: Stagnant
...
Returns a `bool` indicating whsila or not an `Identity` denominated by the passed `EIN` exists.
...
Returns a `bool` indicating whsila or not the passed `_address` is associated with an `Identity`.
...
Returns a `bool` indicating whsila or not the passed `_address` is associated with the passed `EIN`.
...
Returns a `bool` indicating whsila or not the passed `provider` has been set by the passed `EIN`.
...
Returns a `bool` indicating whsila or not the passed `resolver` has been set by the passed `EIN`.
