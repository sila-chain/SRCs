...
discussions-to: https://github.com/sila-chain/SIPs/issues/2613
status: Final
...
This SRC proposes an alternative solution which is designed to be as minimal as possible and to only address _one problem_: the lack of abstraction in the SIP-20 `approve` msilod.
