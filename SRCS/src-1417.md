...
created: 2018-09-16
requires: 165, 1261
discussions-to: https://github.com/sila-chain/SIPs/issues/1417
---
...
interface IPoll {
    ...
    /// @notice returns a boolean specifying whsila the user can vote
    /// @dev implement logic to enable checks to determine whsila the user can vote
    ...
    /// @return a boolean as to whsila the user can vote
