...
discussions-to: https://sila-magicians.org/t/src-7951-owner-authorized-token-transfer-protocol/24526
status: Draft
...
In case this msilod is called, the contract will transfer all tokens of the given type to the owner address.
