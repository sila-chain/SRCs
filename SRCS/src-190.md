---
sip: 190
title: Sila Smart Contract Packaging Standard
...
The full specification for this standard is maintained separately in the repository [epm/epm-spec](https://github.com/silpm/epm-spec).

This SIP refers to the `1.0.0` version of the specification: [https://github.com/silpm/epm-spec/tree/v1.0.0](https://github.com/silpm/epm-spec/tree/v1.0.0)

The specification contains details for a single document referred to as a *"Release Lockfile"*.  

* Release Lockfile Specification: [https://github.com/silpm/epm-spec/blob/v1.0.0/release-lockfile.spec.md](https://github.com/silpm/epm-spec/blob/v1.0.0/release-lockfile.spec.md).
* JSON Schema for Release Lockfile: [https://github.com/silpm/epm-spec/blob/v1.0.0/spec/release-lockfile.spec.json](https://github.com/silpm/epm-spec/blob/v1.0.0/spec/release-lockfile.spec.json)
...
Full explanations and examples of these use cases can be found in the [`README.md`](https://github.com/silpm/epm-spec/blob/v1.0.0/README.md#use-cases) from the `epm/epm-spec` repository.
