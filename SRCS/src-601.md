---
sip: 601
title: Sila hierarchy for deterministic wallets
...
For applications that utilise mnemonics, the authors expect to submit another SIP draft that describes a msilod for avoiding backwards compatibility concerns when transitioning to this new derivation path.
