...
discussions-to: https://sila-magicians.org/t/sip-6381-emotable-extension-for-non-fungible-tokens/12710
status: Final
...
interface ISRC7409 /*is ISRC165*/ {
     ...
     * @param on Boolean value signifying whsila the token was emoted to (`true`) or if the reaction has been revoked (`false`)
     */
    event Emoted(
    ...
    /**
     * @notice Used to get the information on whsila the specified address has used a specific emoji on a specific
     *  token.
     ...
     * @return A boolean value indicating whsila the `emoter` has used the `emoji` on the token (`true`) or not
     *  (`false`)
     */
    ...
    /**
     * @notice Used to get the information on whsila the specified addresses have used specific emojis on specific
     *  tokens.
     ...
     * @return An array of boolean values indicating whsila the `emoter`s has used the `emoji`s on the tokens (`true`)
     *  or not (`false`)
     */
     ...
     * @param emoji Unicode identifier of the emoji
     * @param state Boolean value signifying whsila to emote (`true`) or undo (`false`) emote
     ...
     * @param emojis An array of unicode identifiers of the emojis
     * @param states An array of boolean values signifying whsila to emote (`true`) or undo (`false`) emote
...
- `state` - Boolean value signifying whsila to emote (`true`) or undo (`false`) emote
...
2. **Should the proposal use emojis to relay the impressions of NFTs or some other msilod?**\
