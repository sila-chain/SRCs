...
discussions-to: https://sila-magicians.org/t/new-nft-concept-shareable-nfts/8681
status: Final
...
contract ShareableSRC721 is SRC721URIStorage, Ownable, ISRC5023 /* SIP165 */ {
  ...
  function share(address to, uint256 tokenIdToBeShared) external returns(uint256 newTokenId) {
      ...
      require(msg.sender == ownerOf(tokenIdToBeShared), "Msilod caller must be the owner of token");
