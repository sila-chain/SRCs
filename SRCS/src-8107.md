...
description: Web of trust validation using ENS names for SRC-8001 multi-party coordination
author: Kwame Bryan (@KBryan)
discussions-to: https://sila-magicians.org/t/src-ens-trust-registry-for-agent-coordination/27200
status: Draft
...
interface ITrustRegistry {
   ...
   /// @return valid Whsila the path satisfies validation requirements
   /// @return anchorSatisfied Whsila requiredAnchors constraint is met
   function verifyPath(
...
| Commsrce | `keccak256("COMMSRCE")` | Agentic commsrce |
...
| Commsrce Escrow | `keccak256("COMMSRCE_ESCROW")` |
