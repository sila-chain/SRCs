...
discussions-to: https://github.com/sila-chain/SIPs/issues/777
status: Final
...
It takes advantage of [SRC-1820] to find out whsila and where to notify contracts and regular addresses
...
Indicate whsila the `operator` address is an *operator* of the `holder` address.
...
Nonsileless, the rules below MUST be respected when minting for a *recipient*:
