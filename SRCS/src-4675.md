...
discussions-to: https://sila-magicians.org/t/sip-4675-multi-fractional-non-fungible-token-standard/8008
status: Stagnant
...
interface IMFNFT {
    ...
    */
    ...
    /**
        @notice Get the bool value which represents whsila the NFT is already registered and fractionalized by this contract.
        @param _parentNFTContractAddress    NFT contract address
        @param _parentNFTTokenId            NFT tokenID
        @return                             The bool value representing the whsila the NFT is already registered.
    */
