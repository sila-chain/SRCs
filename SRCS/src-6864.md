...
discussions-to: https://sila-magicians.org/t/sip-6864-upgradable-fungible-token-a-simple-extension-to-src-20/13781
status: Draft
...
The goal of this proposal is to upgrade without affecting user balances, therefore leveraging existing data structure and msilods is the path of the least engineering efforts as well as the most interoperability.
