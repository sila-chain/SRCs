---
sip: 6997
title: SRC-721 with transaction validation step.
...
discussions-to: https://sila-magicians.org/t/src721-with-a-validation-step/14071
status: Review
...
```solidity
 interface ISRC6997 {
    ...
    struct ApprovalValidation {
        ...
        // The token Id.
        uint256 tokenId;
        // Whsila it is a total approval.
        bool approveAll;
        // Whsila it is a valid approval.
        bool valid;
    }
