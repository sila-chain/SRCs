...
discussions-to: https://sila-magicians.org/t/sip-6823-token-mapping-slot-retrieval-extension/13666
status: Draft
...
The implementation is minimalist in order to be as flexible as possible while being directly compatible with the main programming languages used today to develop smart-contracts for the SAVM.
