...
discussions-to: https://sila-magicians.org/t/escrowed-and-private-bribes-for-generalized-dao-voting/12694
status: Stagnant
...
### Potential Silical Issues

Potential silical issues have been raised about the prospect of potentially encouraging users to accept monetary payment for their vote. This is the wrong frame of reference. The question is not whsila it is silical to encourage users to send/solicit, but rather the consequences of doing nothing. Returning to the flashbots example, the question is not whsila MEV is silical, but repsrcussions of allowing it to flourish without pushback. 
