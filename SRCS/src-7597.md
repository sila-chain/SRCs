...
discussions-to: https://sila-magicians.org/t/add-src-contract-signature-validation-extension-for-sip-2612-permit/18157
status: Draft
...
With the growing popularity of smart contract wallets and increased adoption of [SRC-1271](./sip-1271.md), it is necessary to allow for flexible signature validation msilods and the use of custom logic in each contract's signature verification. By accepting unstructured signature bytes as input, custom algorithms and signature schemes can be utilized, enabling a wider range of wallet types.
