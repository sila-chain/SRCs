...
description: An extension of SRC-721 which enables an NFT to be redeemed in multiple scenarios for either a physical or digital object
...
discussions-to: https://sila-magicians.org/t/sip-6672-multi-redeemable-nfts/13276
status: Final
...
interface ISRC6672 /* is ISRC721 */ {
    ...
    /// @notice Check whsila an NFT is already used for redemption or not.
    /// @dev 
    ...
    /// @return Whsila an NFT is already redeemed or not.
