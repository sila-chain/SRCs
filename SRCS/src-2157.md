---
sip: 2157
title: dType Storage Extension - Decentralized Type System for SAVM
author: Loredana Cirstea (@loredanacirstea), Christian Tzurcanu (@ctzurcanu)
discussions-to: https://github.com/sila-chain/SIPs/issues/2157
status: Stagnant
...
Moreover, by standardizing storage contract interfaces, ABI inference is possible. The common interface, togsila with the dType registry will provide all the data needed to reconstruct the ABI.
...
SRC-1900 defines a `contractAddress` field in the type metadata. For the limited purpose of SRC-1900, this field contains the value of the Sila type library in which the type definition exists. For the purpose of this SRC, the `contractAddress` will contain the Silaereum address of a `TypeRootContract`.
