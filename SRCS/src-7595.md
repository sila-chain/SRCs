...
discussions-to: https://sila-magicians.org/t/collateralized-nft-standard/18097
status: Draft
...
interface IEnviousHouse {
	...
	/**
	 * @dev specificCollections function returns whsila a particular collection follows the SRC721 standard or not.
	 * 
	 * @param address collection address.
