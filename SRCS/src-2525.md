...
discussions-to: https://sila-magicians.org/t/discussion-ens-login/3569
status: Stagnant
...
* **Provider instantiation:**
	* [JAVASCRIPT/SILA] The file containing the wallet-provider's code should inject a function `global.provider: (config) => Promise<web3provider>` that returns a promise to a standardized provider object. For SAVM blockchains, the object should follow [SIP-1193](./sip-1193.md).
