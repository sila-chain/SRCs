...
author: Acme (@0xacme), Calder (@caldersil)
discussions-to: https://sila-magicians.org/t/src-7651-fractionally-represented-non-fungible-token/19176
status: Draft
...
interface ISRC7651 is ISRC165 {
  ...
  /// @return Whsila the approval operation was successful or not.
  function approve(
    address spender_,
    uint256 amountOrId_
...
interface ISRC7651NFTTransferExemptable {
  /// @notice Returns whsila an address is NFT transfer exempt.
  /// @param account_ The address to check.
  /// @return Whsila the address is NFT transfer exempt.
