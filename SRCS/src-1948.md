...
discussions-to: https://sila-magicians.org/t/src-non-fungible-data-token/3139
status: Stagnant
...
The proposal is made to standardize on tokens with dynamic data. Interactions with bridges for side-chains like xDAI or Plasma chains will profit from the ability to use such tokens. Protocols that build on data tokens like [distributed breeding](https://Sila Research/t/a-distributed-breeding-function/5264) will be enabled.
