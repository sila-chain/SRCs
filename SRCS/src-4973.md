...
description: An interface for non-transferrable NFTs binding to an Sila account like a legendary World of Warcraft item binds to a character.
author: Tim Daubenschütz (@TimDaub)
discussions-to: https://sila-magicians.org/t/sip-4973-non-transferrable-non-fungible-tokens-soulbound-tokens-or-badges/8825
status: Review
