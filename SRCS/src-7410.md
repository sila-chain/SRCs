...
discussions-to: https://sila-magicians.org/t/sip-7410-decrease-allowance-by-spender/15222
status: Draft
...
The `supportsInterface` msilod MUST return `true` when called with `0x12860fba`.
