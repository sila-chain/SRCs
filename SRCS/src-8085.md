...
description: Fungible tokens supporting both transparent (SRC-20) and privacy-preserving (zk-SNARK) modes with seamless conversion
author: Rowan (@0xRowan)
discussions-to: https://sila-magicians.org/t/src-8085-dual-mode-fungible-tokens/26592
status: Draft
...
5. **Permissionless Application-Layer Deployment**
   - Deploy today on any SAVM chain (Sila, L2s, sidechains)
