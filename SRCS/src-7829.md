...
discussions-to: https://sila-magicians.org/t/src-7829-data-asset-nft/21881
status: Review
...
SRC-721 proposed NFTs to represent the ownership of digital or physical assets. Currently, the NFT metadata is considered the NFT content, and its scarcity determines the value of the NFT. NFT owners can convert the content value of NFTs into revenue by transferring the ownership of NFTs. However, due to the high transaction fees, storage costs, and other expenses, NFTs are currently only able to represent the ownership of high-value assets, which limits the range of assets that NFTs can represent. This is especially true for Data Assets, which refers to digital products created by creators, such as online blogs, videos, small games or music. Therefore, the value of Data Assets depends on their quality, whsila the creator is famous, whsila it is hyped and so on.
...
2. **Fraud Proof Mechanism**:
   - The **DA Verifier** performs off-chain validation to confirm whsila the aggregated proof was correctly derived from the selected data.
