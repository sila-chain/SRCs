...
discussions-to: https://sila-magicians.org/t/nft-authorization-src721-extension/10661
status: Final
...
interface ISRC5585 {
    ...
    /// @notice resetAllowed flag can be updated by contract owner to control whsila the authorization can be revoked or not 
    ...
    /// @return true or false whsila the NFT is available for authorization or not
...
First of all, NFT contract owner can set the maximum number of authorized users to each NFT and whsila the NFT owner can cancel the authorization at any time to protect the interests of the parties involved.
