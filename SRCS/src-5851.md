...
discussions-to: https://sila-magicians.org/t/sip-5815-kyc-certification-issuer-and-verifier-standard/11513
status: Stagnant
...
Test cases for the minimal reference implementation can be found [here](../assets/sip-5851/contracts/test.sol) for using transaction verification regarding whsila the users hold the tokens or not. Use Remix IDE to compile and test the contracts.
