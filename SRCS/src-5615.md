...
discussions-to: https://sila-magicians.org/t/sip-5615-sip-1155-supply-extension/10732
status: Final
...
interface SRC1155Supply is SRC1155 {
  // @notice      This function MUST return whsila the given token id exists, previously existed, or may exist
  // @param   id  The token id of which to check the existence
  // @return      Whsila the given token id exists, previously existed, or may exist
