...
discussions-to: https://github.com/sila-chain/SIPs/issues/2393
status: Stagnant
...
The SIP is backwards-compatible with SIP 1577, the only differences are additional overloaded msilods. Old applications will still be able to function correctly, as they will receive the default `contenthash` record.
