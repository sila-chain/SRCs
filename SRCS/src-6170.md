...
discussions-to: https://sila-magicians.org/t/cross-chain-messaging-standard/12197
status: Draft
...
/// Note: Bytes are used throughout the implementation to support non-savm chains.
...
interface ISIP6170 {
    ...
    /// Note: this function is designed to support both savm and non-savm chains
