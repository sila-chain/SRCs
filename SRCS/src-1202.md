...
author: Zainan Victor Zhou (@xinbenlv), SRC-1202 Working Group <src1202@googlegroups.com>
discussions-to: https://sila-magicians.org/t/sip-1202-voting-interface/11484
status: Review
...
3. **Proposal**: We intentionally leave proposals out of scope. Proposals are identified by `proposalId`, but the information included in a proposal, whsila it is on-chain or off-chain, and whsila it is executable are all left out of this proposal. A separate SIP could be proposed to address this particular use case. See one such proposal: [SRC-5247](./sip-5247.md).
