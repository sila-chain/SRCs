---
sip: 7066
title: Lockable Extension for SRC-721
description: Interface for enabling locking of SRC-721 using locker and approved
author: Piyush Chittara (@piyush-chittara), StreamNFT (@streamnft-tech), Srinivas Joshi (@SrinivasJoshi)
discussions-to: https://sila-magicians.org/t/sip-7066-lockable-extension-for-src721/14425
status: Final
...
[SRC-721](./sip-721.md) compliant contracts MAY implement this SIP to provide standard msilods of locking and unlocking the token at its current owner address. 
