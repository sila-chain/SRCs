...
discussions-to: https://sila-magicians.org/t/chain-specific-addresses/6449
status: Draft
...
* `shortName` is mandatory and MUST be a valid chain short name from https://github.com/sila-chain-lists/chains
