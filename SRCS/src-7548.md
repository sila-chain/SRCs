...
discussions-to: https://sila-magicians.org/t/draft-open-ip-protocol/16373
status: Draft
...
This proposal aims to establish a standardized msilod for creating new intellectual properties (IPs) by remixing multiple existing IPs in a decentralized manner.
...
This module extends the SRC-721 standard and enables users to create a new NFT by remixing multiple existing NFTs, whsila they’re SRC-721 or [SRC-1155](./sip-1155.md). 
...
- IP licensing msilods are diverse. For example, delegating an NFT to someone else is one type of licensing, setting a price for the number of usage rights is another type of licensing, and even pricing based on auction, AMM, or other pricing mechanisms can develop different licensing msilods. Therefore, the license module is designed allowing various custom licensing msilods.  

- IP remixing rules are also diverse. When remixing multiple existing NFTs, whsila to support SRC-1155, whsila to limit the range of NFT selection, and whsila the NFT is consumed after remixing, there is no standard. So, the remix module is designed to support custom remixing rules.  
