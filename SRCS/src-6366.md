...
discussions-to: https://sila-magicians.org/t/sip-6366-a-standard-for-permission-token/9105
status: Review
...
interface ISIP6366Core {
   ...
   * `approve()` msilod SHOULD `revert` if granting `_permission` permission is not
