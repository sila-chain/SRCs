...
discussions-to: https://github.com/sila-chain/SIPs/issues/1922
...
This standard provides basic functionality to load all necessary parameters for the verification of any zk-SNARK into a verifier contract, so that the proof may ultimately return a `true` or `false` response; corresponding to whsila it has been verified or not verified.
...
- `proof`
  ...
  - Dynamic: There are several possible msilods for producing a zk-SNARK proof, including PGHR13, G16, GM17, and future msilods might be developed in future. Although each msilod may produce differently sized proof objects, a dynamic array allows for these differing sizes.
...
- Dr Christian Reitwiessner's excellent [example](https://gist.github.com/chrissil/f9be9d9391efc5beb9704255a8e2989d) of a Verifier contract and elliptic curve pairing library has been instrumental in the Sila community's experimentation and development of zk-SNARK protocols. Many of the naming conventions of this SIP have been kept consistent with his example.
...
##### Notable projects relating to zk-SNARKs
  ...
  1. Christian Reitweissner - snarktest.solidity. https://gist.github.com/chrissil/f9be9d9391efc5beb9704255a8e2989d
