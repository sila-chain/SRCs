...
discussions-to: https://sila-magicians.org/t/src-sip-5198-ens-as-token-holder/10374
status: Stagnant
...
This is nonsileless compatible with other scoped ownership namespaces.
...
describe("FirstENSBankAndTrust", function () {
    ...
    describe("Receive and Claim Token", function () {
        ...
        it("Should ACCEPT/REJECT claimTo based on if ENS owner is msg.sender", async function () {
            ...
            // Steps of testing:
            // mint to charlie
            // charlie send to ENSTrust and recorded under bob.xinbenlvsilsf.sil
