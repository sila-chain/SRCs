...
discussions-to: https://sila-magicians.org/t/sip-5850-store-real-and-imaginary-parts-of-complex-numbers-in-the-least-significant-and-most-significant-16-bytes-respectively-of-a-bytes32-type/11532
status: Stagnant
...
Decimal numbers, either fix or floating, are not yet fully supported by Solidity so enforcing similar standards for complex versions is premature.  It can be suggested that fixed point msilods such as prb-math be used with 18 decimal places, or floating point msilods like abdk.  However, it should be noted that this SIP supports any decimal number representation so long as it fits inside the 16 bytes space.
