...
discussions-to: https://github.com/sila-chain/SIPs/issues/1386
status: Stagnant
...
An issuer can also put the validation msilod in their smart contract that can be called by other smart contracts who need to validate attestations issued by them. This allows each attestor to update their attestation format separately.
 ...
 * need to leave room for new attestation msilods other than the
