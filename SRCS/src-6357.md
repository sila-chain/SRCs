...
discussions-to: https://sila-magicians.org/t/sip-6357-single-contract-multicall/12621
status: Last Call
...
The following JavaScript code, using the Silas library, should atomically transfer `amt` units of an [SRC-20](./sip-20.md) token to both `addressA` and `addressB`.
