...
discussions-to: https://sila-magicians.org/t/sip-5999-legal-use-sharing-repurposing-and-remixing-standard-compatible-with-creative-commons/10553
status: Stagnant
...
Copyright owner per tokenID. Could just be the tokenID owner in a simple use case, or somsiling else if desired by the creator.
