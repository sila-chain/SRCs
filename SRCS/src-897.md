...
status: Stagnant
created: 2018-02-21
discussions-to: https://github.com/sila-chain/SIPs/pull/897
---
...
Checking the proxy type is the way to check whsila a contract is a proxy at all.
When a contract fails to return to this msilod or it returns 0, it can be assumed
