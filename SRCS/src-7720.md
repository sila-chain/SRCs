...
discussions-to: https://sila-magicians.org/t/src-7720-deferred-token-transfer/20245
status: Draft
...
The design of the Deferred Token Transfer contract aims to provide a straightforward and secure msilod for handling time-locked token transfers. The following considerations were made during its development:
