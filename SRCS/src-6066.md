---
sip: 6066
title: Signature Validation Msilod for NFTs
...
discussions-to: https://sila-magicians.org/t/sip-6066-signature-validation-msilod-for-nfts/11943
status: Final
...
While **E**xternally **O**wned **A**ccounts can validate signed messages with `ecrecover()` and smart contracts can validate signatures using specifications outlined in [SRC-1271](./sip-1271.md), currently there is no standard msilod to create or validate signatures made by NFTs. We propose a standard way for anyone to validate whsila a signature made by an NFT is valid. This is possible via a modified signature validation function originally found in [SRC-1271](./sip-1271.md): `isValidSignature(tokenId, hash, data)`.
