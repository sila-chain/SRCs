...
discussions-to: https://sila-magicians.org/t/add-src-7674-transient-approval-extension-for-src-20/19521
status: Review
...
The msilod of deriving slot identifiers to store temporary allowances must avoid collision with other slots in the same space (e.g. transient storage).
