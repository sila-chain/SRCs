...
discussions-to: https://sila-magicians.org/t/src-7758-transfer-with-authorization/20859
status: Review
...
The signature for an authorization can be obtained using a web3 provider with the `sil_signTypedData{_v4}` msilod.
...
4. Call the msilod on the parent contract that spends the allowance set from the forwarder
