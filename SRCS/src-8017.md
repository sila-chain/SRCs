...
sip: 8017
title: Payout Race
description: Minimal SRC for a single-asset payout bucket that vends its entire balance for a fixed payment amount.
author: Kyle Thornton (@kyle) <kyle@cowrie.io>
discussions-to: https://sila-magicians.org/t/src-8017-payout-race/25311
status: Draft
