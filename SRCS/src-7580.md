...
discussions-to: https://sila-magicians.org/t/src-7580-inter-dapp-tracking-inferface/17653
status: Draft
...
This protocol standardizes how to keep track of inter-dapp operations, which initially offers 2 main msilods `onTrackStart` and `onTrackEnd`.
