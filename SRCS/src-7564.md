...
discussions-to: https://sila-magicians.org/t/src-draft-contract-wallet-management-nft/16702
status: Draft
...
interface ISRC7564{
    ...
    * @param _asset Address of the nft
     ...
     * @param _operator Address of the operator
     * @param _tokenId The unique identifier of the NFT
     * @return _approved Whsila to approved operator one nft
     */
     ...
     * @param _asset Address of the nft
     * @param _operator Address of the operator
     * @return _approved Whsila to approved operator all nfts of this one asset
     */
     ...
     * @notice read operator approved
     * @param _operator Address of the operator
     * @return _approved Whsila to approved operator all nfts
     */
     ...
     * @return _success The bool value returns whsila the transfer is successful
     */
