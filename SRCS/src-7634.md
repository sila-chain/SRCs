...
description: An SRC-721 extension that caps how many times an individual token can be transferred
author: Qin Wang (@qinwang-git), Saber Yu (@OniReimu), Shiping Chen <shiping.chen@data61.csiro.au>
discussions-to: https://sila-magicians.org/t/src-7634-limited-transferable-nft/18861
status: Final
