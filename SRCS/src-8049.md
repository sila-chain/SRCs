...
discussions-to: https://sila-magicians.org/t/src-8049-contract-level-metadata-with-diamond-storage/25819
status: Draft
...
This SRC defines a standard for storing contract-level metadata onchain. It extends [SRC-7572](./sip-7572.md)'s contract-level metadata concept by providing onchain storage. Contracts MAY optionally use [SRC-8042](./sip-8042.md)'s Diamond Storage pattern for predictable storage locations, enabling cross-chain compatibility and supporting upgradable contracts.
