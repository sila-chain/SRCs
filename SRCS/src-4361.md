---
sip: 4361
title: Sign-In with Sila
description: Off-chain authentication for Sila accounts to establish sessions.
...
discussions-to: https://sila-magicians.org/t/sip-4361-sign-in-with-sila/7263
status: Final
...
- For Externally Owned Accounts (EOAs), the verification msilod specified in [SRC-191](./sip-191.md) MUST be used.

- For Contract Accounts,
    - The verification msilod specified in [SRC-1271](./sip-1271.md) SHOULD be used, and if it is not, the implementer MUST clearly define the verification msilod to attain security and interoperability for both wallets and relying parties.
