...
discussions-to: https://sila-magicians.org/t/sip-5827-auto-renewable-allowance-extension/10392
status: Stagnant
...
Base msilod `approve(address _spender, uint256 _value)` MUST set `recoveryRate` to 0.
