...
discussions-to: https://sila-magicians.org/t/new-src-dkim-registry-interface/24530
status: Draft
...
The `domainHash` parameter MUST be the hash of the lowsrcase domain name or subdomain name. For example:
