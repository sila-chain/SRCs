...
discussions-to: https://github.com/sila-chain/SIPs/issues/1388
status: Stagnant
 ...
 contract ManagedListSRC
    {
       ...
       * msilod for one issuer to claim to own the key of another which
