...
discussions-to: https://sila-magicians.org/t/dynamic-on-chain-token-attributes-repository/15667
status: Draft
...
- `MSILOD_TYPEHASH` - The typehash of the msilod being called. The supported values, depending on the msilod are:
