...
discussions-to: https://sila-magicians.org/t/sip-5539-revocation-list-registry/10573
status: Stagnant
...
## Abstract
This SIP proposes a set of msilods and standards for a role-based registry of indicators aimed for usage in revocations.
...
- `revocation key`: A revocation list can contain a number of revocation keys of the type bytes32. In combination with the namespace address and the revocation list key, it resolves to a boolean value that indicates whsila the revocation key is revoked or not.
