...
Check, CodeSpell, SIP Walidator, and Markdown Linter.
...
- run HTMLProofer only on changed SRC pages when the pull request changes
  SRC markdown files and nothing else

The optimization is intentionally conservative:

- any non-SRC-markdown change falls back to a full HTMLProofer run
